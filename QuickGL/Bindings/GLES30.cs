...
public static unsafe class GLES30
{
    ...
    internal static void Load()
    {
        ...
        _glDrawRangeElements = (delegate* unmanaged<uint, uint, uint, int, uint, void*, void>)QGL.GetGLProcAddress("glDrawRangeElements");
        _glTexImage3D = (delegate* unmanaged<uint, int, int, int, int, int, int, uint, uint, void*, void>)QGL.GetGLProcAddress("glTexImage3D");
        _glTexSubImage3D = (delegate* unmanaged<uint, int, int, int, int, int, int, int, uint, uint, void*, void>)QGL.GetGLProcAddress("glTexSubImage3D");
        _glCopyTexSubImage3D = (delegate* unmanaged<uint, int, int, int, int, int, int, int, int, void>)QGL.GetGLProcAddress("glCopyTexSubImage3D");
        _glCompressedTexImage3D = (delegate* unmanaged<uint, int, uint, int, int, int, int, int, void*, void>)QGL.GetGLProcAddress("glCompressedTexImage3D");
        _glCompressedTexSubImage3D = (delegate* unmanaged<uint, int, int, int, int, int, int, int, uint, int, void*, void>)QGL.GetGLProcAddress("glCompressedTexSubImage3D");
        ...
        _glDrawBuffers = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glDrawBuffers");
        _glUniformMatrix2x3fv = (delegate* unmanaged<int, int, bool, float*, void>)QGL.GetGLProcAddress("glUniformMatrix2x3fv");
        _glUniformMatrix3x2fv = (delegate* unmanaged<int, int, bool, float*, void>)QGL.GetGLProcAddress("glUniformMatrix3x2fv");
        _glUniformMatrix2x4fv = (delegate* unmanaged<int, int, bool, float*, void>)QGL.GetGLProcAddress("glUniformMatrix2x4fv");
        _glUniformMatrix4x2fv = (delegate* unmanaged<int, int, bool, float*, void>)QGL.GetGLProcAddress("glUniformMatrix4x2fv");
        _glUniformMatrix3x4fv = (delegate* unmanaged<int, int, bool, float*, void>)QGL.GetGLProcAddress("glUniformMatrix3x4fv");
        _glUniformMatrix4x3fv = (delegate* unmanaged<int, int, bool, float*, void>)QGL.GetGLProcAddress("glUniformMatrix4x3fv");
        ...
        _glCopyBufferSubData = (delegate* unmanaged<uint, uint, nint, nint, nint, void>)QGL.GetGLProcAddress("glCopyBufferSubData");
        _glGetUniformIndices = (delegate* unmanaged<uint, int, byte**, uint*, void>)QGL.GetGLProcAddress("glGetUniformIndices");
        _glGetActiveUniformsiv = (delegate* unmanaged<uint, int, uint*, uint, int*, void>)QGL.GetGLProcAddress("glGetActiveUniformsiv");
        _glGetUniformBlockIndex = (delegate* unmanaged<uint, byte*, uint>)QGL.GetGLProcAddress("glGetUniformBlockIndex");
        _glGetActiveUniformBlockiv = (delegate* unmanaged<uint, uint, uint, int*, void>)QGL.GetGLProcAddress("glGetActiveUniformBlockiv");
        _glGetActiveUniformBlockName = (delegate* unmanaged<uint, uint, int, int*, byte*, void>)QGL.GetGLProcAddress("glGetActiveUniformBlockName");
        _glUniformBlockBinding = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glUniformBlockBinding");
        _glDrawArraysInstanced = (delegate* unmanaged<uint, int, int, int, void>)QGL.GetGLProcAddress("glDrawArraysInstanced");
        _glDrawElementsInstanced = (delegate* unmanaged<uint, int, uint, void*, int, void>)QGL.GetGLProcAddress("glDrawElementsInstanced");
        _glFenceSync = (delegate* unmanaged<uint, uint, nint>)QGL.GetGLProcAddress("glFenceSync");
        _glIsSync = (delegate* unmanaged<nint, bool>)QGL.GetGLProcAddress("glIsSync");
        _glDeleteSync = (delegate* unmanaged<nint, void>)QGL.GetGLProcAddress("glDeleteSync");
        _glClientWaitSync = (delegate* unmanaged<nint, uint, ulong, uint>)QGL.GetGLProcAddress("glClientWaitSync");
        _glWaitSync = (delegate* unmanaged<nint, uint, ulong, void>)QGL.GetGLProcAddress("glWaitSync");
        _glGetInteger64v = (delegate* unmanaged<uint, long*, void>)QGL.GetGLProcAddress("glGetInteger64v");
        _glGetSynciv = (delegate* unmanaged<nint, uint, int, int*, int*, void>)QGL.GetGLProcAddress("glGetSynciv");
        _glGetInteger64i_v = (delegate* unmanaged<uint, uint, long*, void>)QGL.GetGLProcAddress("glGetInteger64i_v");
        _glGetBufferParameteri64v = (delegate* unmanaged<uint, uint, long*, void>)QGL.GetGLProcAddress("glGetBufferParameteri64v");
        _glGenSamplers = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glGenSamplers");
        _glDeleteSamplers = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glDeleteSamplers");
        _glIsSampler = (delegate* unmanaged<uint, bool>)QGL.GetGLProcAddress("glIsSampler");
        _glBindSampler = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glBindSampler");
        _glSamplerParameteri = (delegate* unmanaged<uint, uint, int, void>)QGL.GetGLProcAddress("glSamplerParameteri");
        _glSamplerParameteriv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glSamplerParameteriv");
        _glSamplerParameterf = (delegate* unmanaged<uint, uint, float, void>)QGL.GetGLProcAddress("glSamplerParameterf");
        _glSamplerParameterfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glSamplerParameterfv");
        _glGetSamplerParameteriv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetSamplerParameteriv");
        _glGetSamplerParameterfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetSamplerParameterfv");
        _glVertexAttribDivisor = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glVertexAttribDivisor");
        ...
        _glTexStorage2D = (delegate* unmanaged<uint, int, uint, int, int, void>)QGL.GetGLProcAddress("glTexStorage2D");
        _glTexStorage3D = (delegate* unmanaged<uint, int, uint, int, int, int, void>)QGL.GetGLProcAddress("glTexStorage3D");
        _glGetInternalformativ = (delegate* unmanaged<uint, uint, uint, int, int*, void>)QGL.GetGLProcAddress("glGetInternalformativ");
    }
