...
public static unsafe class GL11
{
    ...
    internal static void Load()
    {
        ...
        _glCopyTexImage1D = (delegate* unmanaged<uint, int, uint, int, int, int, int, void>)QGL.GetGLProcAddress("glCopyTexImage1D");
        _glCopyTexImage2D = (delegate* unmanaged<uint, int, uint, int, int, int, int, int, void>)QGL.GetGLProcAddress("glCopyTexImage2D");
        _glCopyTexSubImage1D = (delegate* unmanaged<uint, int, int, int, int, int, void>)QGL.GetGLProcAddress("glCopyTexSubImage1D");
        _glCopyTexSubImage2D = (delegate* unmanaged<uint, int, int, int, int, int, int, int, void>)QGL.GetGLProcAddress("glCopyTexSubImage2D");
        _glTexSubImage1D = (delegate* unmanaged<uint, int, int, int, uint, uint, void*, void>)QGL.GetGLProcAddress("glTexSubImage1D");
        ...
        _glArrayElement = (delegate* unmanaged<int, void>)QGL.GetGLProcAddress("glArrayElement");
        ...
        _glEdgeFlagPointer = (delegate* unmanaged<int, void*, void>)QGL.GetGLProcAddress("glEdgeFlagPointer");
        _glEnableClientState = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glEnableClientState");
        _glIndexPointer = (delegate* unmanaged<uint, int, void*, void>)QGL.GetGLProcAddress("glIndexPointer");
        _glInterleavedArrays = (delegate* unmanaged<uint, int, void*, void>)QGL.GetGLProcAddress("glInterleavedArrays");
        ...
        _glAreTexturesResident = (delegate* unmanaged<int, uint*, bool*, bool>)QGL.GetGLProcAddress("glAreTexturesResident");
        _glPrioritizeTextures = (delegate* unmanaged<int, uint*, float*, void>)QGL.GetGLProcAddress("glPrioritizeTextures");
        _glIndexub = (delegate* unmanaged<byte, void>)QGL.GetGLProcAddress("glIndexub");
        _glIndexubv = (delegate* unmanaged<byte*, void>)QGL.GetGLProcAddress("glIndexubv");
        _glPopClientAttrib = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glPopClientAttrib");
        _glPushClientAttrib = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glPushClientAttrib");
    }
