...
public static unsafe class GL30
{
    ...
    {
        _glColorMaski = (delegate* unmanaged<uint, bool, bool, bool, bool, void>)QGL.GetGLProcAddress("glColorMaski");
        _glGetBooleani_v = (delegate* unmanaged<uint, uint, bool*, void>)QGL.GetGLProcAddress("glGetBooleani_v");
        _glGetIntegeri_v = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetIntegeri_v");
        _glEnablei = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glEnablei");
        _glDisablei = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glDisablei");
        _glIsEnabledi = (delegate* unmanaged<uint, uint, bool>)QGL.GetGLProcAddress("glIsEnabledi");
        _glBeginTransformFeedback = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glBeginTransformFeedback");
        _glEndTransformFeedback = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glEndTransformFeedback");
        _glBindBufferRange = (delegate* unmanaged<uint, uint, uint, nint, nint, void>)QGL.GetGLProcAddress("glBindBufferRange");
        _glBindBufferBase = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glBindBufferBase");
        _glTransformFeedbackVaryings = (delegate* unmanaged<uint, int, byte**, uint, void>)QGL.GetGLProcAddress("glTransformFeedbackVaryings");
        _glGetTransformFeedbackVarying = (delegate* unmanaged<uint, uint, int, int*, int*, uint*, byte*, void>)QGL.GetGLProcAddress("glGetTransformFeedbackVarying");
        _glClampColor = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glClampColor");
        _glBeginConditionalRender = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glBeginConditionalRender");
        _glEndConditionalRender = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glEndConditionalRender");
        _glVertexAttribIPointer = (delegate* unmanaged<uint, int, uint, int, void*, void>)QGL.GetGLProcAddress("glVertexAttribIPointer");
        _glGetVertexAttribIiv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetVertexAttribIiv");
        _glGetVertexAttribIuiv = (delegate* unmanaged<uint, uint, uint*, void>)QGL.GetGLProcAddress("glGetVertexAttribIuiv");
        _glVertexAttribI1i = (delegate* unmanaged<uint, int, void>)QGL.GetGLProcAddress("glVertexAttribI1i");
        _glVertexAttribI2i = (delegate* unmanaged<uint, int, int, void>)QGL.GetGLProcAddress("glVertexAttribI2i");
        _glVertexAttribI3i = (delegate* unmanaged<uint, int, int, int, void>)QGL.GetGLProcAddress("glVertexAttribI3i");
        _glVertexAttribI4i = (delegate* unmanaged<uint, int, int, int, int, void>)QGL.GetGLProcAddress("glVertexAttribI4i");
        _glVertexAttribI1ui = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glVertexAttribI1ui");
        _glVertexAttribI2ui = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glVertexAttribI2ui");
        _glVertexAttribI3ui = (delegate* unmanaged<uint, uint, uint, uint, void>)QGL.GetGLProcAddress("glVertexAttribI3ui");
        _glVertexAttribI4ui = (delegate* unmanaged<uint, uint, uint, uint, uint, void>)QGL.GetGLProcAddress("glVertexAttribI4ui");
        _glVertexAttribI1iv = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glVertexAttribI1iv");
        _glVertexAttribI2iv = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glVertexAttribI2iv");
        _glVertexAttribI3iv = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glVertexAttribI3iv");
        _glVertexAttribI4iv = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glVertexAttribI4iv");
        _glVertexAttribI1uiv = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glVertexAttribI1uiv");
        _glVertexAttribI2uiv = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glVertexAttribI2uiv");
        _glVertexAttribI3uiv = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glVertexAttribI3uiv");
        _glVertexAttribI4uiv = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glVertexAttribI4uiv");
        _glVertexAttribI4bv = (delegate* unmanaged<uint, sbyte*, void>)QGL.GetGLProcAddress("glVertexAttribI4bv");
        _glVertexAttribI4sv = (delegate* unmanaged<uint, short*, void>)QGL.GetGLProcAddress("glVertexAttribI4sv");
        _glVertexAttribI4ubv = (delegate* unmanaged<uint, byte*, void>)QGL.GetGLProcAddress("glVertexAttribI4ubv");
        _glVertexAttribI4usv = (delegate* unmanaged<uint, ushort*, void>)QGL.GetGLProcAddress("glVertexAttribI4usv");
        _glGetUniformuiv = (delegate* unmanaged<uint, int, uint*, void>)QGL.GetGLProcAddress("glGetUniformuiv");
        _glBindFragDataLocation = (delegate* unmanaged<uint, uint, byte*, void>)QGL.GetGLProcAddress("glBindFragDataLocation");
        _glGetFragDataLocation = (delegate* unmanaged<uint, byte*, int>)QGL.GetGLProcAddress("glGetFragDataLocation");
        _glUniform1ui = (delegate* unmanaged<int, uint, void>)QGL.GetGLProcAddress("glUniform1ui");
        _glUniform2ui = (delegate* unmanaged<int, uint, uint, void>)QGL.GetGLProcAddress("glUniform2ui");
        _glUniform3ui = (delegate* unmanaged<int, uint, uint, uint, void>)QGL.GetGLProcAddress("glUniform3ui");
        _glUniform4ui = (delegate* unmanaged<int, uint, uint, uint, uint, void>)QGL.GetGLProcAddress("glUniform4ui");
        _glUniform1uiv = (delegate* unmanaged<int, int, uint*, void>)QGL.GetGLProcAddress("glUniform1uiv");
        _glUniform2uiv = (delegate* unmanaged<int, int, uint*, void>)QGL.GetGLProcAddress("glUniform2uiv");
        _glUniform3uiv = (delegate* unmanaged<int, int, uint*, void>)QGL.GetGLProcAddress("glUniform3uiv");
        _glUniform4uiv = (delegate* unmanaged<int, int, uint*, void>)QGL.GetGLProcAddress("glUniform4uiv");
        _glTexParameterIiv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glTexParameterIiv");
        _glTexParameterIuiv = (delegate* unmanaged<uint, uint, uint*, void>)QGL.GetGLProcAddress("glTexParameterIuiv");
        _glGetTexParameterIiv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetTexParameterIiv");
        _glGetTexParameterIuiv = (delegate* unmanaged<uint, uint, uint*, void>)QGL.GetGLProcAddress("glGetTexParameterIuiv");
        _glClearBufferiv = (delegate* unmanaged<uint, int, int*, void>)QGL.GetGLProcAddress("glClearBufferiv");
        _glClearBufferuiv = (delegate* unmanaged<uint, int, uint*, void>)QGL.GetGLProcAddress("glClearBufferuiv");
        _glClearBufferfv = (delegate* unmanaged<uint, int, float*, void>)QGL.GetGLProcAddress("glClearBufferfv");
        _glClearBufferfi = (delegate* unmanaged<uint, int, float, int, void>)QGL.GetGLProcAddress("glClearBufferfi");
        _glGetStringi = (delegate* unmanaged<uint, uint, byte*>)QGL.GetGLProcAddress("glGetStringi");
        ...
        _glMapBufferRange = (delegate* unmanaged<uint, nint, nint, uint, void*>)QGL.GetGLProcAddress("glMapBufferRange");
        _glFlushMappedBufferRange = (delegate* unmanaged<uint, nint, nint, void>)QGL.GetGLProcAddress("glFlushMappedBufferRange");
        _glBindVertexArray = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glBindVertexArray");
        _glDeleteVertexArrays = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glDeleteVertexArrays");
        _glGenVertexArrays = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glGenVertexArrays");
        _glIsVertexArray = (delegate* unmanaged<uint, bool>)QGL.GetGLProcAddress("glIsVertexArray");
    }
