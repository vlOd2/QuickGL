...
public static unsafe class GL45
{
    #region Constants
    ...
    public const int GL_MAX_CULL_DISTANCES = 0x000082F9;
    public const int GL_MAX_COMBINED_CLIP_AND_CULL_DISTANCES = 0x000082FA;
    ...
    internal static delegate* unmanaged<uint, int, int, void*, void> _glGetnCompressedTexImage = null;
    internal static delegate* unmanaged<uint, int, uint, uint, int, void*, void> _glGetnTexImage = null;
    internal static delegate* unmanaged<uint, int, int, double*, void> _glGetnUniformdv = null;
    ...
    internal static delegate* unmanaged<uint, uint, int, double*, void> _glGetnMapdv = null;
    internal static delegate* unmanaged<uint, uint, int, float*, void> _glGetnMapfv = null;
    internal static delegate* unmanaged<uint, uint, int, int*, void> _glGetnMapiv = null;
    internal static delegate* unmanaged<uint, int, float*, void> _glGetnPixelMapfv = null;
    internal static delegate* unmanaged<uint, int, uint*, void> _glGetnPixelMapuiv = null;
    internal static delegate* unmanaged<uint, int, ushort*, void> _glGetnPixelMapusv = null;
    internal static delegate* unmanaged<int, byte*, void> _glGetnPolygonStipple = null;
    internal static delegate* unmanaged<uint, uint, uint, int, void*, void> _glGetnColorTable = null;
    internal static delegate* unmanaged<uint, uint, uint, int, void*, void> _glGetnConvolutionFilter = null;
    internal static delegate* unmanaged<uint, uint, uint, int, void*, int, void*, void*, void> _glGetnSeparableFilter = null;
    internal static delegate* unmanaged<uint, bool, uint, uint, int, void*, void> _glGetnHistogram = null;
    internal static delegate* unmanaged<uint, bool, uint, uint, int, void*, void> _glGetnMinmax = null;
    ...
    internal static void Load()
    {
        ...
        _glGetTextureSubImage = (delegate* unmanaged<uint, int, int, int, int, int, int, int, uint, uint, int, void*, void>)QGL.GetGLProcAddress("glGetTextureSubImage");
        _glGetCompressedTextureSubImage = (delegate* unmanaged<uint, int, int, int, int, int, int, int, int, void*, void>)QGL.GetGLProcAddress("glGetCompressedTextureSubImage");
        _glGetGraphicsResetStatus = (delegate* unmanaged<uint>)QGL.GetGLProcAddress("glGetGraphicsResetStatus");
        _glGetnCompressedTexImage = (delegate* unmanaged<uint, int, int, void*, void>)QGL.GetGLProcAddress("glGetnCompressedTexImage");
        _glGetnTexImage = (delegate* unmanaged<uint, int, uint, uint, int, void*, void>)QGL.GetGLProcAddress("glGetnTexImage");
        _glGetnUniformdv = (delegate* unmanaged<uint, int, int, double*, void>)QGL.GetGLProcAddress("glGetnUniformdv");
        _glGetnUniformfv = (delegate* unmanaged<uint, int, int, float*, void>)QGL.GetGLProcAddress("glGetnUniformfv");
        _glGetnUniformiv = (delegate* unmanaged<uint, int, int, int*, void>)QGL.GetGLProcAddress("glGetnUniformiv");
        _glGetnUniformuiv = (delegate* unmanaged<uint, int, int, uint*, void>)QGL.GetGLProcAddress("glGetnUniformuiv");
        _glReadnPixels = (delegate* unmanaged<int, int, int, int, uint, uint, int, void*, void>)QGL.GetGLProcAddress("glReadnPixels");
        _glGetnMapdv = (delegate* unmanaged<uint, uint, int, double*, void>)QGL.GetGLProcAddress("glGetnMapdv");
        _glGetnMapfv = (delegate* unmanaged<uint, uint, int, float*, void>)QGL.GetGLProcAddress("glGetnMapfv");
        _glGetnMapiv = (delegate* unmanaged<uint, uint, int, int*, void>)QGL.GetGLProcAddress("glGetnMapiv");
        _glGetnPixelMapfv = (delegate* unmanaged<uint, int, float*, void>)QGL.GetGLProcAddress("glGetnPixelMapfv");
        _glGetnPixelMapuiv = (delegate* unmanaged<uint, int, uint*, void>)QGL.GetGLProcAddress("glGetnPixelMapuiv");
        _glGetnPixelMapusv = (delegate* unmanaged<uint, int, ushort*, void>)QGL.GetGLProcAddress("glGetnPixelMapusv");
        _glGetnPolygonStipple = (delegate* unmanaged<int, byte*, void>)QGL.GetGLProcAddress("glGetnPolygonStipple");
        _glGetnColorTable = (delegate* unmanaged<uint, uint, uint, int, void*, void>)QGL.GetGLProcAddress("glGetnColorTable");
        _glGetnConvolutionFilter = (delegate* unmanaged<uint, uint, uint, int, void*, void>)QGL.GetGLProcAddress("glGetnConvolutionFilter");
        _glGetnSeparableFilter = (delegate* unmanaged<uint, uint, uint, int, void*, int, void*, void*, void>)QGL.GetGLProcAddress("glGetnSeparableFilter");
        _glGetnHistogram = (delegate* unmanaged<uint, bool, uint, uint, int, void*, void>)QGL.GetGLProcAddress("glGetnHistogram");
        _glGetnMinmax = (delegate* unmanaged<uint, bool, uint, uint, int, void*, void>)QGL.GetGLProcAddress("glGetnMinmax");
        _glTextureBarrier = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glTextureBarrier");
    }
    ...
    internal static void Unload()
    {
        ...
        _glGetnCompressedTexImage = null;
        _glGetnTexImage = null;
        _glGetnUniformdv = null;
        ...
        _glGetnMapfv = null;
        _glGetnMapiv = null;
        _glGetnPixelMapfv = null;
        _glGetnPixelMapuiv = null;
        _glGetnPixelMapusv = null;
        _glGetnPolygonStipple = null;
        _glGetnColorTable = null;
        _glGetnConvolutionFilter = null;
        _glGetnSeparableFilter = null;
        _glGetnHistogram = null;
        _glGetnMinmax = null;
    ...
    public static void glGetnCompressedTexImage(uint target, int lod, int bufSize, void* pixels) { QGLFeature.VerifyFunc((nint)_glGetnCompressedTexImage); _glGetnCompressedTexImage(target, lod, bufSize, pixels); }
    public static void glGetnTexImage(uint target, int level, uint format, uint type, int bufSize, void* pixels) { QGLFeature.VerifyFunc((nint)_glGetnTexImage); _glGetnTexImage(target, level, format, type, bufSize, pixels); }
    public static void glGetnUniformdv(uint program, int location, int bufSize, double* @params) { QGLFeature.VerifyFunc((nint)_glGetnUniformdv); _glGetnUniformdv(program, location, bufSize, @params); }
    ...
    public static void glGetnMapdv(uint target, uint query, int bufSize, double* v) { QGLFeature.VerifyFunc((nint)_glGetnMapdv); _glGetnMapdv(target, query, bufSize, v); }
    public static void glGetnMapfv(uint target, uint query, int bufSize, float* v) { QGLFeature.VerifyFunc((nint)_glGetnMapfv); _glGetnMapfv(target, query, bufSize, v); }
    public static void glGetnMapiv(uint target, uint query, int bufSize, int* v) { QGLFeature.VerifyFunc((nint)_glGetnMapiv); _glGetnMapiv(target, query, bufSize, v); }
    public static void glGetnPixelMapfv(uint map, int bufSize, float* values) { QGLFeature.VerifyFunc((nint)_glGetnPixelMapfv); _glGetnPixelMapfv(map, bufSize, values); }
    public static void glGetnPixelMapuiv(uint map, int bufSize, uint* values) { QGLFeature.VerifyFunc((nint)_glGetnPixelMapuiv); _glGetnPixelMapuiv(map, bufSize, values); }
    public static void glGetnPixelMapusv(uint map, int bufSize, ushort* values) { QGLFeature.VerifyFunc((nint)_glGetnPixelMapusv); _glGetnPixelMapusv(map, bufSize, values); }
    public static void glGetnPolygonStipple(int bufSize, byte* pattern) { QGLFeature.VerifyFunc((nint)_glGetnPolygonStipple); _glGetnPolygonStipple(bufSize, pattern); }
    public static void glGetnColorTable(uint target, uint format, uint type, int bufSize, void* table) { QGLFeature.VerifyFunc((nint)_glGetnColorTable); _glGetnColorTable(target, format, type, bufSize, table); }
    public static void glGetnConvolutionFilter(uint target, uint format, uint type, int bufSize, void* image) { QGLFeature.VerifyFunc((nint)_glGetnConvolutionFilter); _glGetnConvolutionFilter(target, format, type, bufSize, image); }
    public static void glGetnSeparableFilter(uint target, uint format, uint type, int rowBufSize, void* row, int columnBufSize, void* column, void* span) { QGLFeature.VerifyFunc((nint)_glGetnSeparableFilter); _glGetnSeparableFilter(target, format, type, rowBufSize, row, columnBufSize, column, span); }
    public static void glGetnHistogram(uint target, bool reset, uint format, uint type, int bufSize, void* values) { QGLFeature.VerifyFunc((nint)_glGetnHistogram); _glGetnHistogram(target, reset, format, type, bufSize, values); }
    public static void glGetnMinmax(uint target, bool reset, uint format, uint type, int bufSize, void* values) { QGLFeature.VerifyFunc((nint)_glGetnMinmax); _glGetnMinmax(target, reset, format, type, bufSize, values); }
    public static void glTextureBarrier() { QGLFeature.VerifyFunc((nint)_glTextureBarrier); _glTextureBarrier(); }
    #endregion

    internal static QGLFeature FeatureInfo => new("GL_VERSION_4_5", false, false);
}
