...
// Generated at: 2025-09-27T19:41:02.9784894Z
...
public static unsafe class GL45
{
    ...
    internal static void Load()
    {
        ...
        _glGetnCompressedTexImage = (delegate* unmanaged<uint, int, int, void*, void>)QuickGL.GetGLProcAddress("glGetnCompressedTexImage");
        _glGetnTexImage = (delegate* unmanaged<uint, int, uint, uint, int, void*, void>)QuickGL.GetGLProcAddress("glGetnTexImage");
        _glGetnUniformdv = (delegate* unmanaged<uint, int, int, double*, void>)QuickGL.GetGLProcAddress("glGetnUniformdv");
        ...
        _glGetnMapdv = (delegate* unmanaged<uint, uint, int, double*, void>)QuickGL.GetGLProcAddress("glGetnMapdv");
        _glGetnMapfv = (delegate* unmanaged<uint, uint, int, float*, void>)QuickGL.GetGLProcAddress("glGetnMapfv");
        _glGetnMapiv = (delegate* unmanaged<uint, uint, int, int*, void>)QuickGL.GetGLProcAddress("glGetnMapiv");
        _glGetnPixelMapfv = (delegate* unmanaged<uint, int, float*, void>)QuickGL.GetGLProcAddress("glGetnPixelMapfv");
        _glGetnPixelMapuiv = (delegate* unmanaged<uint, int, uint*, void>)QuickGL.GetGLProcAddress("glGetnPixelMapuiv");
        _glGetnPixelMapusv = (delegate* unmanaged<uint, int, ushort*, void>)QuickGL.GetGLProcAddress("glGetnPixelMapusv");
        _glGetnPolygonStipple = (delegate* unmanaged<int, byte*, void>)QuickGL.GetGLProcAddress("glGetnPolygonStipple");
        _glGetnColorTable = (delegate* unmanaged<uint, uint, uint, int, void*, void>)QuickGL.GetGLProcAddress("glGetnColorTable");
        _glGetnConvolutionFilter = (delegate* unmanaged<uint, uint, uint, int, void*, void>)QuickGL.GetGLProcAddress("glGetnConvolutionFilter");
        _glGetnSeparableFilter = (delegate* unmanaged<uint, uint, uint, int, void*, int, void*, void*, void>)QuickGL.GetGLProcAddress("glGetnSeparableFilter");
        _glGetnHistogram = (delegate* unmanaged<uint, bool, uint, uint, int, void*, void>)QuickGL.GetGLProcAddress("glGetnHistogram");
        _glGetnMinmax = (delegate* unmanaged<uint, bool, uint, uint, int, void*, void>)QuickGL.GetGLProcAddress("glGetnMinmax");
