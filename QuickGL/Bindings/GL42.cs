...
public static unsafe class GL42
{
    ...
    {
        _glDrawArraysInstancedBaseInstance = (delegate* unmanaged<uint, int, int, int, uint, void>)QGL.GetGLProcAddress("glDrawArraysInstancedBaseInstance");
        _glDrawElementsInstancedBaseInstance = (delegate* unmanaged<uint, int, uint, void*, int, uint, void>)QGL.GetGLProcAddress("glDrawElementsInstancedBaseInstance");
        _glDrawElementsInstancedBaseVertexBaseInstance = (delegate* unmanaged<uint, int, uint, void*, int, int, uint, void>)QGL.GetGLProcAddress("glDrawElementsInstancedBaseVertexBaseInstance");
        ...
        _glTexStorage1D = (delegate* unmanaged<uint, int, uint, int, void>)QGL.GetGLProcAddress("glTexStorage1D");
