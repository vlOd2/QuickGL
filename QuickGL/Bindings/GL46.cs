...
public static unsafe class GL46
{
    ...
    {
        _glSpecializeShader = (delegate* unmanaged<uint, byte*, uint, uint*, uint*, void>)QGL.GetGLProcAddress("glSpecializeShader");
        _glMultiDrawArraysIndirectCount = (delegate* unmanaged<uint, void*, nint, int, int, void>)QGL.GetGLProcAddress("glMultiDrawArraysIndirectCount");
        _glMultiDrawElementsIndirectCount = (delegate* unmanaged<uint, uint, void*, nint, int, int, void>)QGL.GetGLProcAddress("glMultiDrawElementsIndirectCount");
        _glPolygonOffsetClamp = (delegate* unmanaged<float, float, float, void>)QGL.GetGLProcAddress("glPolygonOffsetClamp");
    }
