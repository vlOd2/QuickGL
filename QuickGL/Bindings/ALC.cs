...
public static unsafe class ALC
{
    ...
    {
        _alcCreateContext = (delegate* unmanaged<ALCdevice*, int*, ALCcontext*>)QGL.GetALProcAddress("alcCreateContext");
        _alcMakeContextCurrent = (delegate* unmanaged<ALCcontext*, bool>)QGL.GetALProcAddress("alcMakeContextCurrent");
        _alcProcessContext = (delegate* unmanaged<ALCcontext*, void>)QGL.GetALProcAddress("alcProcessContext");
        _alcSuspendContext = (delegate* unmanaged<ALCcontext*, void>)QGL.GetALProcAddress("alcSuspendContext");
        _alcDestroyContext = (delegate* unmanaged<ALCcontext*, void>)QGL.GetALProcAddress("alcDestroyContext");
        _alcGetCurrentContext = (delegate* unmanaged<ALCcontext*>)QGL.GetALProcAddress("alcGetCurrentContext");
        _alcGetContextsDevice = (delegate* unmanaged<ALCcontext*, ALCdevice*>)QGL.GetALProcAddress("alcGetContextsDevice");
        _alcOpenDevice = (delegate* unmanaged<byte*, ALCdevice*>)QGL.GetALProcAddress("alcOpenDevice");
        _alcCloseDevice = (delegate* unmanaged<ALCdevice*, bool>)QGL.GetALProcAddress("alcCloseDevice");
        _alcGetError = (delegate* unmanaged<ALCdevice*, int>)QGL.GetALProcAddress("alcGetError");
        _alcIsExtensionPresent = (delegate* unmanaged<ALCdevice*, byte*, bool>)QGL.GetALProcAddress("alcIsExtensionPresent");
        _alcGetProcAddress = (delegate* unmanaged<ALCdevice*, byte*, void*>)QGL.GetALProcAddress("alcGetProcAddress");
        _alcGetEnumValue = (delegate* unmanaged<ALCdevice*, byte*, int>)QGL.GetALProcAddress("alcGetEnumValue");
        _alcGetString = (delegate* unmanaged<ALCdevice*, int, byte*>)QGL.GetALProcAddress("alcGetString");
        _alcGetIntegerv = (delegate* unmanaged<ALCdevice*, int, int, int*, void>)QGL.GetALProcAddress("alcGetIntegerv");
        _alcCaptureOpenDevice = (delegate* unmanaged<byte*, uint, int, int, ALCdevice*>)QGL.GetALProcAddress("alcCaptureOpenDevice");
        _alcCaptureCloseDevice = (delegate* unmanaged<ALCdevice*, bool>)QGL.GetALProcAddress("alcCaptureCloseDevice");
        _alcCaptureStart = (delegate* unmanaged<ALCdevice*, void>)QGL.GetALProcAddress("alcCaptureStart");
        _alcCaptureStop = (delegate* unmanaged<ALCdevice*, void>)QGL.GetALProcAddress("alcCaptureStop");
        _alcCaptureSamples = (delegate* unmanaged<ALCdevice*, void*, int, void>)QGL.GetALProcAddress("alcCaptureSamples");
    }
