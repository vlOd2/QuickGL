...
public static unsafe class GLES32
{
    ...
    {
        _glBlendBarrier = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glBlendBarrier");
        ...
        _glDrawElementsBaseVertex = (delegate* unmanaged<uint, int, uint, void*, int, void>)QGL.GetGLProcAddress("glDrawElementsBaseVertex");
        _glDrawRangeElementsBaseVertex = (delegate* unmanaged<uint, uint, uint, int, uint, void*, int, void>)QGL.GetGLProcAddress("glDrawRangeElementsBaseVertex");
        _glDrawElementsInstancedBaseVertex = (delegate* unmanaged<uint, int, uint, void*, int, int, void>)QGL.GetGLProcAddress("glDrawElementsInstancedBaseVertex");
        _glFramebufferTexture = (delegate* unmanaged<uint, uint, uint, int, void>)QGL.GetGLProcAddress("glFramebufferTexture");
        _glPrimitiveBoundingBox = (delegate* unmanaged<float, float, float, float, float, float, float, float, void>)QGL.GetGLProcAddress("glPrimitiveBoundingBox");
        ...
        _glTexBuffer = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glTexBuffer");
