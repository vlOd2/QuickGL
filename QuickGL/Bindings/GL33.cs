...
public static unsafe class GL33
{
    ...
    {
        _glBindFragDataLocationIndexed = (delegate* unmanaged<uint, uint, uint, byte*, void>)QGL.GetGLProcAddress("glBindFragDataLocationIndexed");
        _glGetFragDataIndex = (delegate* unmanaged<uint, byte*, int>)QGL.GetGLProcAddress("glGetFragDataIndex");
        ...
        _glSamplerParameterIiv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glSamplerParameterIiv");
        _glSamplerParameterIuiv = (delegate* unmanaged<uint, uint, uint*, void>)QGL.GetGLProcAddress("glSamplerParameterIuiv");
        _glGetSamplerParameteriv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetSamplerParameteriv");
        _glGetSamplerParameterIiv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetSamplerParameterIiv");
        _glGetSamplerParameterfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetSamplerParameterfv");
        _glGetSamplerParameterIuiv = (delegate* unmanaged<uint, uint, uint*, void>)QGL.GetGLProcAddress("glGetSamplerParameterIuiv");
        ...
        _glVertexAttribP1ui = (delegate* unmanaged<uint, uint, bool, uint, void>)QGL.GetGLProcAddress("glVertexAttribP1ui");
        _glVertexAttribP1uiv = (delegate* unmanaged<uint, uint, bool, uint*, void>)QGL.GetGLProcAddress("glVertexAttribP1uiv");
        _glVertexAttribP2ui = (delegate* unmanaged<uint, uint, bool, uint, void>)QGL.GetGLProcAddress("glVertexAttribP2ui");
        _glVertexAttribP2uiv = (delegate* unmanaged<uint, uint, bool, uint*, void>)QGL.GetGLProcAddress("glVertexAttribP2uiv");
        _glVertexAttribP3ui = (delegate* unmanaged<uint, uint, bool, uint, void>)QGL.GetGLProcAddress("glVertexAttribP3ui");
        _glVertexAttribP3uiv = (delegate* unmanaged<uint, uint, bool, uint*, void>)QGL.GetGLProcAddress("glVertexAttribP3uiv");
        _glVertexAttribP4ui = (delegate* unmanaged<uint, uint, bool, uint, void>)QGL.GetGLProcAddress("glVertexAttribP4ui");
        _glVertexAttribP4uiv = (delegate* unmanaged<uint, uint, bool, uint*, void>)QGL.GetGLProcAddress("glVertexAttribP4uiv");
        _glVertexP2ui = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glVertexP2ui");
        _glVertexP2uiv = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glVertexP2uiv");
        _glVertexP3ui = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glVertexP3ui");
        _glVertexP3uiv = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glVertexP3uiv");
        _glVertexP4ui = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glVertexP4ui");
        _glVertexP4uiv = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glVertexP4uiv");
        _glTexCoordP1ui = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glTexCoordP1ui");
        _glTexCoordP1uiv = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glTexCoordP1uiv");
        _glTexCoordP2ui = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glTexCoordP2ui");
        _glTexCoordP2uiv = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glTexCoordP2uiv");
        _glTexCoordP3ui = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glTexCoordP3ui");
        _glTexCoordP3uiv = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glTexCoordP3uiv");
        _glTexCoordP4ui = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glTexCoordP4ui");
        _glTexCoordP4uiv = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glTexCoordP4uiv");
        _glMultiTexCoordP1ui = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glMultiTexCoordP1ui");
        _glMultiTexCoordP1uiv = (delegate* unmanaged<uint, uint, uint*, void>)QGL.GetGLProcAddress("glMultiTexCoordP1uiv");
        _glMultiTexCoordP2ui = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glMultiTexCoordP2ui");
        _glMultiTexCoordP2uiv = (delegate* unmanaged<uint, uint, uint*, void>)QGL.GetGLProcAddress("glMultiTexCoordP2uiv");
        _glMultiTexCoordP3ui = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glMultiTexCoordP3ui");
        _glMultiTexCoordP3uiv = (delegate* unmanaged<uint, uint, uint*, void>)QGL.GetGLProcAddress("glMultiTexCoordP3uiv");
        _glMultiTexCoordP4ui = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glMultiTexCoordP4ui");
        _glMultiTexCoordP4uiv = (delegate* unmanaged<uint, uint, uint*, void>)QGL.GetGLProcAddress("glMultiTexCoordP4uiv");
        _glNormalP3ui = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glNormalP3ui");
        _glNormalP3uiv = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glNormalP3uiv");
        _glColorP3ui = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glColorP3ui");
        _glColorP3uiv = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glColorP3uiv");
        _glColorP4ui = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glColorP4ui");
        _glColorP4uiv = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glColorP4uiv");
        _glSecondaryColorP3ui = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glSecondaryColorP3ui");
        _glSecondaryColorP3uiv = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glSecondaryColorP3uiv");
    }
