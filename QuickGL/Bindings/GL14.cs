...
// Generated at: 2025-09-27T20:04:55.6559786Z
...
public static unsafe class GL14
{
    ...
    internal static delegate* unmanaged<uint, int*, uint, nint, int, void> _glMultiDrawElements = null;
    ...
    internal static void Load()
    {
        ...
        _glMultiDrawElements = (delegate* unmanaged<uint, int*, uint, nint, int, void>)QuickGL.GetGLProcAddress("glMultiDrawElements");
    ...
    public static void glMultiDrawElements(uint mode, int* count, uint type, nint indices, int drawcount) { QGLFeature.VerifyFunc((nint)_glMultiDrawElements); _glMultiDrawElements(mode, count, type, indices, drawcount); }
