...
public static unsafe class GLEXTframebufferblitlayers
{
    ...
    {
        _glBlitFramebufferLayersEXT = (delegate* unmanaged<int, int, int, int, int, int, int, int, uint, uint, void>)QGL.GetGLProcAddress("glBlitFramebufferLayersEXT");
        _glBlitFramebufferLayerEXT = (delegate* unmanaged<int, int, int, int, int, int, int, int, int, int, uint, uint, void>)QGL.GetGLProcAddress("glBlitFramebufferLayerEXT");
    }
