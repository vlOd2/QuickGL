...
public static unsafe class GLEXTvertexshader
{
    ...
    {
        _glBeginVertexShaderEXT = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glBeginVertexShaderEXT");
        _glEndVertexShaderEXT = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glEndVertexShaderEXT");
        _glBindVertexShaderEXT = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glBindVertexShaderEXT");
        _glGenVertexShadersEXT = (delegate* unmanaged<uint, uint>)QGL.GetGLProcAddress("glGenVertexShadersEXT");
        _glDeleteVertexShaderEXT = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glDeleteVertexShaderEXT");
        _glShaderOp1EXT = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glShaderOp1EXT");
        _glShaderOp2EXT = (delegate* unmanaged<uint, uint, uint, uint, void>)QGL.GetGLProcAddress("glShaderOp2EXT");
        _glShaderOp3EXT = (delegate* unmanaged<uint, uint, uint, uint, uint, void>)QGL.GetGLProcAddress("glShaderOp3EXT");
        _glSwizzleEXT = (delegate* unmanaged<uint, uint, uint, uint, uint, uint, void>)QGL.GetGLProcAddress("glSwizzleEXT");
        _glWriteMaskEXT = (delegate* unmanaged<uint, uint, uint, uint, uint, uint, void>)QGL.GetGLProcAddress("glWriteMaskEXT");
        _glInsertComponentEXT = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glInsertComponentEXT");
        _glExtractComponentEXT = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glExtractComponentEXT");
        _glGenSymbolsEXT = (delegate* unmanaged<uint, uint, uint, uint, uint>)QGL.GetGLProcAddress("glGenSymbolsEXT");
        _glSetInvariantEXT = (delegate* unmanaged<uint, uint, void*, void>)QGL.GetGLProcAddress("glSetInvariantEXT");
        _glSetLocalConstantEXT = (delegate* unmanaged<uint, uint, void*, void>)QGL.GetGLProcAddress("glSetLocalConstantEXT");
        _glVariantbvEXT = (delegate* unmanaged<uint, sbyte*, void>)QGL.GetGLProcAddress("glVariantbvEXT");
        _glVariantsvEXT = (delegate* unmanaged<uint, short*, void>)QGL.GetGLProcAddress("glVariantsvEXT");
        _glVariantivEXT = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glVariantivEXT");
        _glVariantfvEXT = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glVariantfvEXT");
        _glVariantdvEXT = (delegate* unmanaged<uint, double*, void>)QGL.GetGLProcAddress("glVariantdvEXT");
        _glVariantubvEXT = (delegate* unmanaged<uint, byte*, void>)QGL.GetGLProcAddress("glVariantubvEXT");
        _glVariantusvEXT = (delegate* unmanaged<uint, ushort*, void>)QGL.GetGLProcAddress("glVariantusvEXT");
        _glVariantuivEXT = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glVariantuivEXT");
        _glVariantPointerEXT = (delegate* unmanaged<uint, uint, uint, void*, void>)QGL.GetGLProcAddress("glVariantPointerEXT");
        _glEnableVariantClientStateEXT = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glEnableVariantClientStateEXT");
        _glDisableVariantClientStateEXT = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glDisableVariantClientStateEXT");
        _glBindLightParameterEXT = (delegate* unmanaged<uint, uint, uint>)QGL.GetGLProcAddress("glBindLightParameterEXT");
        _glBindMaterialParameterEXT = (delegate* unmanaged<uint, uint, uint>)QGL.GetGLProcAddress("glBindMaterialParameterEXT");
        _glBindTexGenParameterEXT = (delegate* unmanaged<uint, uint, uint, uint>)QGL.GetGLProcAddress("glBindTexGenParameterEXT");
        _glBindTextureUnitParameterEXT = (delegate* unmanaged<uint, uint, uint>)QGL.GetGLProcAddress("glBindTextureUnitParameterEXT");
        _glBindParameterEXT = (delegate* unmanaged<uint, uint>)QGL.GetGLProcAddress("glBindParameterEXT");
        _glIsVariantEnabledEXT = (delegate* unmanaged<uint, uint, bool>)QGL.GetGLProcAddress("glIsVariantEnabledEXT");
        _glGetVariantBooleanvEXT = (delegate* unmanaged<uint, uint, bool*, void>)QGL.GetGLProcAddress("glGetVariantBooleanvEXT");
        _glGetVariantIntegervEXT = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetVariantIntegervEXT");
        _glGetVariantFloatvEXT = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetVariantFloatvEXT");
        _glGetVariantPointervEXT = (delegate* unmanaged<uint, uint, void**, void>)QGL.GetGLProcAddress("glGetVariantPointervEXT");
        _glGetInvariantBooleanvEXT = (delegate* unmanaged<uint, uint, bool*, void>)QGL.GetGLProcAddress("glGetInvariantBooleanvEXT");
        _glGetInvariantIntegervEXT = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetInvariantIntegervEXT");
        _glGetInvariantFloatvEXT = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetInvariantFloatvEXT");
        _glGetLocalConstantBooleanvEXT = (delegate* unmanaged<uint, uint, bool*, void>)QGL.GetGLProcAddress("glGetLocalConstantBooleanvEXT");
        _glGetLocalConstantIntegervEXT = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetLocalConstantIntegervEXT");
        _glGetLocalConstantFloatvEXT = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetLocalConstantFloatvEXT");
    }
