...
public static unsafe class GLEXTmemoryobject
{
    ...
    {
        _glGetUnsignedBytevEXT = (delegate* unmanaged<uint, byte*, void>)QGL.GetGLProcAddress("glGetUnsignedBytevEXT");
        _glGetUnsignedBytei_vEXT = (delegate* unmanaged<uint, uint, byte*, void>)QGL.GetGLProcAddress("glGetUnsignedBytei_vEXT");
        _glDeleteMemoryObjectsEXT = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glDeleteMemoryObjectsEXT");
        _glIsMemoryObjectEXT = (delegate* unmanaged<uint, bool>)QGL.GetGLProcAddress("glIsMemoryObjectEXT");
        _glCreateMemoryObjectsEXT = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glCreateMemoryObjectsEXT");
        _glMemoryObjectParameterivEXT = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glMemoryObjectParameterivEXT");
        _glGetMemoryObjectParameterivEXT = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetMemoryObjectParameterivEXT");
        _glTexStorageMem2DEXT = (delegate* unmanaged<uint, int, uint, int, int, uint, ulong, void>)QGL.GetGLProcAddress("glTexStorageMem2DEXT");
        _glTexStorageMem2DMultisampleEXT = (delegate* unmanaged<uint, int, uint, int, int, bool, uint, ulong, void>)QGL.GetGLProcAddress("glTexStorageMem2DMultisampleEXT");
        _glTexStorageMem3DEXT = (delegate* unmanaged<uint, int, uint, int, int, int, uint, ulong, void>)QGL.GetGLProcAddress("glTexStorageMem3DEXT");
        _glTexStorageMem3DMultisampleEXT = (delegate* unmanaged<uint, int, uint, int, int, int, bool, uint, ulong, void>)QGL.GetGLProcAddress("glTexStorageMem3DMultisampleEXT");
        _glBufferStorageMemEXT = (delegate* unmanaged<uint, nint, uint, ulong, void>)QGL.GetGLProcAddress("glBufferStorageMemEXT");
        _glTextureStorageMem2DEXT = (delegate* unmanaged<uint, int, uint, int, int, uint, ulong, void>)QGL.GetGLProcAddress("glTextureStorageMem2DEXT");
        _glTextureStorageMem2DMultisampleEXT = (delegate* unmanaged<uint, int, uint, int, int, bool, uint, ulong, void>)QGL.GetGLProcAddress("glTextureStorageMem2DMultisampleEXT");
        _glTextureStorageMem3DEXT = (delegate* unmanaged<uint, int, uint, int, int, int, uint, ulong, void>)QGL.GetGLProcAddress("glTextureStorageMem3DEXT");
        _glTextureStorageMem3DMultisampleEXT = (delegate* unmanaged<uint, int, uint, int, int, int, bool, uint, ulong, void>)QGL.GetGLProcAddress("glTextureStorageMem3DMultisampleEXT");
        _glNamedBufferStorageMemEXT = (delegate* unmanaged<uint, nint, uint, ulong, void>)QGL.GetGLProcAddress("glNamedBufferStorageMemEXT");
        _glTexStorageMem1DEXT = (delegate* unmanaged<uint, int, uint, int, uint, ulong, void>)QGL.GetGLProcAddress("glTexStorageMem1DEXT");
        _glTextureStorageMem1DEXT = (delegate* unmanaged<uint, int, uint, int, uint, ulong, void>)QGL.GetGLProcAddress("glTextureStorageMem1DEXT");
    }
