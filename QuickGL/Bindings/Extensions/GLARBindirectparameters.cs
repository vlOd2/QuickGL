...
public static unsafe class GLARBindirectparameters
{
    ...
    {
        _glMultiDrawArraysIndirectCountARB = (delegate* unmanaged<uint, void*, nint, int, int, void>)QGL.GetGLProcAddress("glMultiDrawArraysIndirectCountARB");
        _glMultiDrawElementsIndirectCountARB = (delegate* unmanaged<uint, uint, void*, nint, int, int, void>)QGL.GetGLProcAddress("glMultiDrawElementsIndirectCountARB");
    }
