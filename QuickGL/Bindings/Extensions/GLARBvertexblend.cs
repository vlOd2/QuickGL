...
public static unsafe class GLARBvertexblend
{
    ...
    {
        _glWeightbvARB = (delegate* unmanaged<int, sbyte*, void>)QGL.GetGLProcAddress("glWeightbvARB");
        _glWeightsvARB = (delegate* unmanaged<int, short*, void>)QGL.GetGLProcAddress("glWeightsvARB");
        _glWeightivARB = (delegate* unmanaged<int, int*, void>)QGL.GetGLProcAddress("glWeightivARB");
        _glWeightfvARB = (delegate* unmanaged<int, float*, void>)QGL.GetGLProcAddress("glWeightfvARB");
        _glWeightdvARB = (delegate* unmanaged<int, double*, void>)QGL.GetGLProcAddress("glWeightdvARB");
        _glWeightubvARB = (delegate* unmanaged<int, byte*, void>)QGL.GetGLProcAddress("glWeightubvARB");
        _glWeightusvARB = (delegate* unmanaged<int, ushort*, void>)QGL.GetGLProcAddress("glWeightusvARB");
        _glWeightuivARB = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glWeightuivARB");
        _glWeightPointerARB = (delegate* unmanaged<int, uint, int, void*, void>)QGL.GetGLProcAddress("glWeightPointerARB");
        _glVertexBlendARB = (delegate* unmanaged<int, void>)QGL.GetGLProcAddress("glVertexBlendARB");
    }
