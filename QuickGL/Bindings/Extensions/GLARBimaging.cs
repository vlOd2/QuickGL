...
public static unsafe class GLARBimaging
{
    ...
    internal static void Load()
    {
        ...
        _glColorTable = (delegate* unmanaged<uint, uint, int, uint, uint, void*, void>)QGL.GetGLProcAddress("glColorTable");
        _glColorTableParameterfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glColorTableParameterfv");
        _glColorTableParameteriv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glColorTableParameteriv");
        _glCopyColorTable = (delegate* unmanaged<uint, uint, int, int, int, void>)QGL.GetGLProcAddress("glCopyColorTable");
        _glGetColorTable = (delegate* unmanaged<uint, uint, uint, void*, void>)QGL.GetGLProcAddress("glGetColorTable");
        _glGetColorTableParameterfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetColorTableParameterfv");
        _glGetColorTableParameteriv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetColorTableParameteriv");
        _glColorSubTable = (delegate* unmanaged<uint, int, int, uint, uint, void*, void>)QGL.GetGLProcAddress("glColorSubTable");
        _glCopyColorSubTable = (delegate* unmanaged<uint, int, int, int, int, void>)QGL.GetGLProcAddress("glCopyColorSubTable");
        _glConvolutionFilter1D = (delegate* unmanaged<uint, uint, int, uint, uint, void*, void>)QGL.GetGLProcAddress("glConvolutionFilter1D");
        _glConvolutionFilter2D = (delegate* unmanaged<uint, uint, int, int, uint, uint, void*, void>)QGL.GetGLProcAddress("glConvolutionFilter2D");
        _glConvolutionParameterf = (delegate* unmanaged<uint, uint, float, void>)QGL.GetGLProcAddress("glConvolutionParameterf");
        _glConvolutionParameterfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glConvolutionParameterfv");
        _glConvolutionParameteri = (delegate* unmanaged<uint, uint, int, void>)QGL.GetGLProcAddress("glConvolutionParameteri");
        _glConvolutionParameteriv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glConvolutionParameteriv");
        _glCopyConvolutionFilter1D = (delegate* unmanaged<uint, uint, int, int, int, void>)QGL.GetGLProcAddress("glCopyConvolutionFilter1D");
        _glCopyConvolutionFilter2D = (delegate* unmanaged<uint, uint, int, int, int, int, void>)QGL.GetGLProcAddress("glCopyConvolutionFilter2D");
        _glGetConvolutionFilter = (delegate* unmanaged<uint, uint, uint, void*, void>)QGL.GetGLProcAddress("glGetConvolutionFilter");
        _glGetConvolutionParameterfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetConvolutionParameterfv");
        _glGetConvolutionParameteriv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetConvolutionParameteriv");
        _glGetSeparableFilter = (delegate* unmanaged<uint, uint, uint, void*, void*, void*, void>)QGL.GetGLProcAddress("glGetSeparableFilter");
        _glSeparableFilter2D = (delegate* unmanaged<uint, uint, int, int, uint, uint, void*, void*, void>)QGL.GetGLProcAddress("glSeparableFilter2D");
        _glGetHistogram = (delegate* unmanaged<uint, bool, uint, uint, void*, void>)QGL.GetGLProcAddress("glGetHistogram");
        _glGetHistogramParameterfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetHistogramParameterfv");
        _glGetHistogramParameteriv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetHistogramParameteriv");
        _glGetMinmax = (delegate* unmanaged<uint, bool, uint, uint, void*, void>)QGL.GetGLProcAddress("glGetMinmax");
        _glGetMinmaxParameterfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetMinmaxParameterfv");
        _glGetMinmaxParameteriv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetMinmaxParameteriv");
        _glHistogram = (delegate* unmanaged<uint, int, uint, bool, void>)QGL.GetGLProcAddress("glHistogram");
        _glMinmax = (delegate* unmanaged<uint, uint, bool, void>)QGL.GetGLProcAddress("glMinmax");
        _glResetHistogram = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glResetHistogram");
        _glResetMinmax = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glResetMinmax");
    }
