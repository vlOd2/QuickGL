...
public static unsafe class GLARBviewportarray
{
    ...
    internal static void Load()
    {
        ...
        _glDepthRangeArraydvNV = (delegate* unmanaged<uint, int, double*, void>)QGL.GetGLProcAddress("glDepthRangeArraydvNV");
        _glDepthRangeIndexeddNV = (delegate* unmanaged<uint, double, double, void>)QGL.GetGLProcAddress("glDepthRangeIndexeddNV");
    }
