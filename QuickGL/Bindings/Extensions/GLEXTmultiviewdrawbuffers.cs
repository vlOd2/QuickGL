...
public static unsafe class GLEXTmultiviewdrawbuffers
{
    ...
    {
        _glReadBufferIndexedEXT = (delegate* unmanaged<uint, int, void>)QGL.GetGLProcAddress("glReadBufferIndexedEXT");
        _glDrawBuffersIndexedEXT = (delegate* unmanaged<int, uint*, int*, void>)QGL.GetGLProcAddress("glDrawBuffersIndexedEXT");
        _glGetIntegeri_vEXT = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetIntegeri_vEXT");
    }
