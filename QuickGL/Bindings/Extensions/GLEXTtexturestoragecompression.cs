...
public static unsafe class GLEXTtexturestoragecompression
{
    ...
    {
        _glTexStorageAttribs2DEXT = (delegate* unmanaged<uint, int, uint, int, int, int*, void>)QGL.GetGLProcAddress("glTexStorageAttribs2DEXT");
        _glTexStorageAttribs3DEXT = (delegate* unmanaged<uint, int, uint, int, int, int, int*, void>)QGL.GetGLProcAddress("glTexStorageAttribs3DEXT");
    }
