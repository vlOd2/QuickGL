...
public static unsafe class GLARBdrawbuffersblend
{
    ...
    {
        _glBlendEquationiARB = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glBlendEquationiARB");
        _glBlendEquationSeparateiARB = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glBlendEquationSeparateiARB");
        _glBlendFunciARB = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glBlendFunciARB");
        _glBlendFuncSeparateiARB = (delegate* unmanaged<uint, uint, uint, uint, uint, void>)QGL.GetGLProcAddress("glBlendFuncSeparateiARB");
    }
