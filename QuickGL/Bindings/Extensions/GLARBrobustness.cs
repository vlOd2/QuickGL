...
public static unsafe class GLARBrobustness
{
    ...
    {
        _glGetGraphicsResetStatusARB = (delegate* unmanaged<uint>)QGL.GetGLProcAddress("glGetGraphicsResetStatusARB");
        _glGetnTexImageARB = (delegate* unmanaged<uint, int, uint, uint, int, void*, void>)QGL.GetGLProcAddress("glGetnTexImageARB");
        _glReadnPixelsARB = (delegate* unmanaged<int, int, int, int, uint, uint, int, void*, void>)QGL.GetGLProcAddress("glReadnPixelsARB");
        _glGetnCompressedTexImageARB = (delegate* unmanaged<uint, int, int, void*, void>)QGL.GetGLProcAddress("glGetnCompressedTexImageARB");
        _glGetnUniformfvARB = (delegate* unmanaged<uint, int, int, float*, void>)QGL.GetGLProcAddress("glGetnUniformfvARB");
        _glGetnUniformivARB = (delegate* unmanaged<uint, int, int, int*, void>)QGL.GetGLProcAddress("glGetnUniformivARB");
        _glGetnUniformuivARB = (delegate* unmanaged<uint, int, int, uint*, void>)QGL.GetGLProcAddress("glGetnUniformuivARB");
        _glGetnUniformdvARB = (delegate* unmanaged<uint, int, int, double*, void>)QGL.GetGLProcAddress("glGetnUniformdvARB");
        _glGetnMapdvARB = (delegate* unmanaged<uint, uint, int, double*, void>)QGL.GetGLProcAddress("glGetnMapdvARB");
        _glGetnMapfvARB = (delegate* unmanaged<uint, uint, int, float*, void>)QGL.GetGLProcAddress("glGetnMapfvARB");
        _glGetnMapivARB = (delegate* unmanaged<uint, uint, int, int*, void>)QGL.GetGLProcAddress("glGetnMapivARB");
        _glGetnPixelMapfvARB = (delegate* unmanaged<uint, int, float*, void>)QGL.GetGLProcAddress("glGetnPixelMapfvARB");
        _glGetnPixelMapuivARB = (delegate* unmanaged<uint, int, uint*, void>)QGL.GetGLProcAddress("glGetnPixelMapuivARB");
        _glGetnPixelMapusvARB = (delegate* unmanaged<uint, int, ushort*, void>)QGL.GetGLProcAddress("glGetnPixelMapusvARB");
        _glGetnPolygonStippleARB = (delegate* unmanaged<int, byte*, void>)QGL.GetGLProcAddress("glGetnPolygonStippleARB");
        _glGetnColorTableARB = (delegate* unmanaged<uint, uint, uint, int, void*, void>)QGL.GetGLProcAddress("glGetnColorTableARB");
        _glGetnConvolutionFilterARB = (delegate* unmanaged<uint, uint, uint, int, void*, void>)QGL.GetGLProcAddress("glGetnConvolutionFilterARB");
        _glGetnSeparableFilterARB = (delegate* unmanaged<uint, uint, uint, int, void*, int, void*, void*, void>)QGL.GetGLProcAddress("glGetnSeparableFilterARB");
        _glGetnHistogramARB = (delegate* unmanaged<uint, bool, uint, uint, int, void*, void>)QGL.GetGLProcAddress("glGetnHistogramARB");
        _glGetnMinmaxARB = (delegate* unmanaged<uint, bool, uint, uint, int, void*, void>)QGL.GetGLProcAddress("glGetnMinmaxARB");
    }
