...
public static unsafe class GLARBbindlesstexture
{
    ...
    {
        _glGetTextureHandleARB = (delegate* unmanaged<uint, ulong>)QGL.GetGLProcAddress("glGetTextureHandleARB");
        _glGetTextureSamplerHandleARB = (delegate* unmanaged<uint, uint, ulong>)QGL.GetGLProcAddress("glGetTextureSamplerHandleARB");
        _glMakeTextureHandleResidentARB = (delegate* unmanaged<ulong, void>)QGL.GetGLProcAddress("glMakeTextureHandleResidentARB");
        _glMakeTextureHandleNonResidentARB = (delegate* unmanaged<ulong, void>)QGL.GetGLProcAddress("glMakeTextureHandleNonResidentARB");
        _glGetImageHandleARB = (delegate* unmanaged<uint, int, bool, int, uint, ulong>)QGL.GetGLProcAddress("glGetImageHandleARB");
        _glMakeImageHandleResidentARB = (delegate* unmanaged<ulong, uint, void>)QGL.GetGLProcAddress("glMakeImageHandleResidentARB");
        _glMakeImageHandleNonResidentARB = (delegate* unmanaged<ulong, void>)QGL.GetGLProcAddress("glMakeImageHandleNonResidentARB");
        _glUniformHandleui64ARB = (delegate* unmanaged<int, ulong, void>)QGL.GetGLProcAddress("glUniformHandleui64ARB");
        _glUniformHandleui64vARB = (delegate* unmanaged<int, int, ulong*, void>)QGL.GetGLProcAddress("glUniformHandleui64vARB");
        _glProgramUniformHandleui64ARB = (delegate* unmanaged<uint, int, ulong, void>)QGL.GetGLProcAddress("glProgramUniformHandleui64ARB");
        _glProgramUniformHandleui64vARB = (delegate* unmanaged<uint, int, int, ulong*, void>)QGL.GetGLProcAddress("glProgramUniformHandleui64vARB");
        _glIsTextureHandleResidentARB = (delegate* unmanaged<ulong, bool>)QGL.GetGLProcAddress("glIsTextureHandleResidentARB");
        _glIsImageHandleResidentARB = (delegate* unmanaged<ulong, bool>)QGL.GetGLProcAddress("glIsImageHandleResidentARB");
        _glVertexAttribL1ui64ARB = (delegate* unmanaged<uint, ulong, void>)QGL.GetGLProcAddress("glVertexAttribL1ui64ARB");
        _glVertexAttribL1ui64vARB = (delegate* unmanaged<uint, ulong*, void>)QGL.GetGLProcAddress("glVertexAttribL1ui64vARB");
        _glGetVertexAttribLui64vARB = (delegate* unmanaged<uint, uint, ulong*, void>)QGL.GetGLProcAddress("glGetVertexAttribLui64vARB");
    }
