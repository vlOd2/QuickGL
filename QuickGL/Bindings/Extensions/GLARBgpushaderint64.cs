...
public static unsafe class GLARBgpushaderint64
{
    ...
    {
        _glUniform1i64ARB = (delegate* unmanaged<int, long, void>)QGL.GetGLProcAddress("glUniform1i64ARB");
        _glUniform2i64ARB = (delegate* unmanaged<int, long, long, void>)QGL.GetGLProcAddress("glUniform2i64ARB");
        _glUniform3i64ARB = (delegate* unmanaged<int, long, long, long, void>)QGL.GetGLProcAddress("glUniform3i64ARB");
        _glUniform4i64ARB = (delegate* unmanaged<int, long, long, long, long, void>)QGL.GetGLProcAddress("glUniform4i64ARB");
        _glUniform1i64vARB = (delegate* unmanaged<int, int, long*, void>)QGL.GetGLProcAddress("glUniform1i64vARB");
        _glUniform2i64vARB = (delegate* unmanaged<int, int, long*, void>)QGL.GetGLProcAddress("glUniform2i64vARB");
        _glUniform3i64vARB = (delegate* unmanaged<int, int, long*, void>)QGL.GetGLProcAddress("glUniform3i64vARB");
        _glUniform4i64vARB = (delegate* unmanaged<int, int, long*, void>)QGL.GetGLProcAddress("glUniform4i64vARB");
        _glUniform1ui64ARB = (delegate* unmanaged<int, ulong, void>)QGL.GetGLProcAddress("glUniform1ui64ARB");
        _glUniform2ui64ARB = (delegate* unmanaged<int, ulong, ulong, void>)QGL.GetGLProcAddress("glUniform2ui64ARB");
        _glUniform3ui64ARB = (delegate* unmanaged<int, ulong, ulong, ulong, void>)QGL.GetGLProcAddress("glUniform3ui64ARB");
        _glUniform4ui64ARB = (delegate* unmanaged<int, ulong, ulong, ulong, ulong, void>)QGL.GetGLProcAddress("glUniform4ui64ARB");
        _glUniform1ui64vARB = (delegate* unmanaged<int, int, ulong*, void>)QGL.GetGLProcAddress("glUniform1ui64vARB");
        _glUniform2ui64vARB = (delegate* unmanaged<int, int, ulong*, void>)QGL.GetGLProcAddress("glUniform2ui64vARB");
        _glUniform3ui64vARB = (delegate* unmanaged<int, int, ulong*, void>)QGL.GetGLProcAddress("glUniform3ui64vARB");
        _glUniform4ui64vARB = (delegate* unmanaged<int, int, ulong*, void>)QGL.GetGLProcAddress("glUniform4ui64vARB");
        _glGetUniformi64vARB = (delegate* unmanaged<uint, int, long*, void>)QGL.GetGLProcAddress("glGetUniformi64vARB");
        _glGetUniformui64vARB = (delegate* unmanaged<uint, int, ulong*, void>)QGL.GetGLProcAddress("glGetUniformui64vARB");
        _glGetnUniformi64vARB = (delegate* unmanaged<uint, int, int, long*, void>)QGL.GetGLProcAddress("glGetnUniformi64vARB");
        _glGetnUniformui64vARB = (delegate* unmanaged<uint, int, int, ulong*, void>)QGL.GetGLProcAddress("glGetnUniformui64vARB");
        _glProgramUniform1i64ARB = (delegate* unmanaged<uint, int, long, void>)QGL.GetGLProcAddress("glProgramUniform1i64ARB");
        _glProgramUniform2i64ARB = (delegate* unmanaged<uint, int, long, long, void>)QGL.GetGLProcAddress("glProgramUniform2i64ARB");
        _glProgramUniform3i64ARB = (delegate* unmanaged<uint, int, long, long, long, void>)QGL.GetGLProcAddress("glProgramUniform3i64ARB");
        _glProgramUniform4i64ARB = (delegate* unmanaged<uint, int, long, long, long, long, void>)QGL.GetGLProcAddress("glProgramUniform4i64ARB");
        _glProgramUniform1i64vARB = (delegate* unmanaged<uint, int, int, long*, void>)QGL.GetGLProcAddress("glProgramUniform1i64vARB");
        _glProgramUniform2i64vARB = (delegate* unmanaged<uint, int, int, long*, void>)QGL.GetGLProcAddress("glProgramUniform2i64vARB");
        _glProgramUniform3i64vARB = (delegate* unmanaged<uint, int, int, long*, void>)QGL.GetGLProcAddress("glProgramUniform3i64vARB");
        _glProgramUniform4i64vARB = (delegate* unmanaged<uint, int, int, long*, void>)QGL.GetGLProcAddress("glProgramUniform4i64vARB");
        _glProgramUniform1ui64ARB = (delegate* unmanaged<uint, int, ulong, void>)QGL.GetGLProcAddress("glProgramUniform1ui64ARB");
        _glProgramUniform2ui64ARB = (delegate* unmanaged<uint, int, ulong, ulong, void>)QGL.GetGLProcAddress("glProgramUniform2ui64ARB");
        _glProgramUniform3ui64ARB = (delegate* unmanaged<uint, int, ulong, ulong, ulong, void>)QGL.GetGLProcAddress("glProgramUniform3ui64ARB");
        _glProgramUniform4ui64ARB = (delegate* unmanaged<uint, int, ulong, ulong, ulong, ulong, void>)QGL.GetGLProcAddress("glProgramUniform4ui64ARB");
        _glProgramUniform1ui64vARB = (delegate* unmanaged<uint, int, int, ulong*, void>)QGL.GetGLProcAddress("glProgramUniform1ui64vARB");
        _glProgramUniform2ui64vARB = (delegate* unmanaged<uint, int, int, ulong*, void>)QGL.GetGLProcAddress("glProgramUniform2ui64vARB");
        _glProgramUniform3ui64vARB = (delegate* unmanaged<uint, int, int, ulong*, void>)QGL.GetGLProcAddress("glProgramUniform3ui64vARB");
        _glProgramUniform4ui64vARB = (delegate* unmanaged<uint, int, int, ulong*, void>)QGL.GetGLProcAddress("glProgramUniform4ui64vARB");
    }
