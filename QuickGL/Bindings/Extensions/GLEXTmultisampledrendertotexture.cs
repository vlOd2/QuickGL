...
public static unsafe class GLEXTmultisampledrendertotexture
{
    ...
    {
        _glRenderbufferStorageMultisampleEXT = (delegate* unmanaged<uint, int, uint, int, int, void>)QGL.GetGLProcAddress("glRenderbufferStorageMultisampleEXT");
        _glFramebufferTexture2DMultisampleEXT = (delegate* unmanaged<uint, uint, uint, uint, int, int, void>)QGL.GetGLProcAddress("glFramebufferTexture2DMultisampleEXT");
    }
