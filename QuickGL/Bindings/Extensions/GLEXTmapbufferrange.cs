...
public static unsafe class GLEXTmapbufferrange
{
    ...
    {
        _glMapBufferRangeEXT = (delegate* unmanaged<uint, nint, nint, uint, void*>)QGL.GetGLProcAddress("glMapBufferRangeEXT");
        _glFlushMappedBufferRangeEXT = (delegate* unmanaged<uint, nint, nint, void>)QGL.GetGLProcAddress("glFlushMappedBufferRangeEXT");
    }
