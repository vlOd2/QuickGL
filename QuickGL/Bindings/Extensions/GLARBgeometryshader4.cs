...
public static unsafe class GLARBgeometryshader4
{
    ...
    {
        _glProgramParameteriARB = (delegate* unmanaged<uint, uint, int, void>)QGL.GetGLProcAddress("glProgramParameteriARB");
        _glFramebufferTextureARB = (delegate* unmanaged<uint, uint, uint, int, void>)QGL.GetGLProcAddress("glFramebufferTextureARB");
        _glFramebufferTextureLayerARB = (delegate* unmanaged<uint, uint, uint, int, int, void>)QGL.GetGLProcAddress("glFramebufferTextureLayerARB");
        _glFramebufferTextureFaceARB = (delegate* unmanaged<uint, uint, uint, int, uint, void>)QGL.GetGLProcAddress("glFramebufferTextureFaceARB");
    }
