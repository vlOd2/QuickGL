...
public static unsafe class GLARBpointparameters
{
    ...
    {
        _glPointParameterfARB = (delegate* unmanaged<uint, float, void>)QGL.GetGLProcAddress("glPointParameterfARB");
        _glPointParameterfvARB = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glPointParameterfvARB");
    }
