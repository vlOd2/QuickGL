...
public static unsafe class GLARBdrawinstanced
{
    ...
    {
        _glDrawArraysInstancedARB = (delegate* unmanaged<uint, int, int, int, void>)QGL.GetGLProcAddress("glDrawArraysInstancedARB");
        _glDrawElementsInstancedARB = (delegate* unmanaged<uint, int, uint, void*, int, void>)QGL.GetGLProcAddress("glDrawElementsInstancedARB");
    }
