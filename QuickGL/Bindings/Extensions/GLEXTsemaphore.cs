...
public static unsafe class GLEXTsemaphore
{
    ...
    internal static void Load()
    {
        ...
        _glGenSemaphoresEXT = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glGenSemaphoresEXT");
        _glDeleteSemaphoresEXT = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glDeleteSemaphoresEXT");
        _glIsSemaphoreEXT = (delegate* unmanaged<uint, bool>)QGL.GetGLProcAddress("glIsSemaphoreEXT");
        _glSemaphoreParameterui64vEXT = (delegate* unmanaged<uint, uint, ulong*, void>)QGL.GetGLProcAddress("glSemaphoreParameterui64vEXT");
        _glGetSemaphoreParameterui64vEXT = (delegate* unmanaged<uint, uint, ulong*, void>)QGL.GetGLProcAddress("glGetSemaphoreParameterui64vEXT");
        _glWaitSemaphoreEXT = (delegate* unmanaged<uint, uint, uint*, uint, uint*, uint*, void>)QGL.GetGLProcAddress("glWaitSemaphoreEXT");
        _glSignalSemaphoreEXT = (delegate* unmanaged<uint, uint, uint*, uint, uint*, uint*, void>)QGL.GetGLProcAddress("glSignalSemaphoreEXT");
    }
