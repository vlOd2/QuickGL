...
public static unsafe class GLARBocclusionquery
{
    ...
    {
        _glGenQueriesARB = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glGenQueriesARB");
        _glDeleteQueriesARB = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glDeleteQueriesARB");
        _glIsQueryARB = (delegate* unmanaged<uint, bool>)QGL.GetGLProcAddress("glIsQueryARB");
        _glBeginQueryARB = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glBeginQueryARB");
        _glEndQueryARB = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glEndQueryARB");
        _glGetQueryivARB = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetQueryivARB");
        _glGetQueryObjectivARB = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetQueryObjectivARB");
        _glGetQueryObjectuivARB = (delegate* unmanaged<uint, uint, uint*, void>)QGL.GetGLProcAddress("glGetQueryObjectuivARB");
    }
