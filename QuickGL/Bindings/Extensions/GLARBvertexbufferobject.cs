...
public static unsafe class GLARBvertexbufferobject
{
    ...
    {
        _glBindBufferARB = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glBindBufferARB");
        _glDeleteBuffersARB = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glDeleteBuffersARB");
        _glGenBuffersARB = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glGenBuffersARB");
        _glIsBufferARB = (delegate* unmanaged<uint, bool>)QGL.GetGLProcAddress("glIsBufferARB");
        _glBufferDataARB = (delegate* unmanaged<uint, nint, void*, uint, void>)QGL.GetGLProcAddress("glBufferDataARB");
        _glBufferSubDataARB = (delegate* unmanaged<uint, nint, nint, void*, void>)QGL.GetGLProcAddress("glBufferSubDataARB");
        _glGetBufferSubDataARB = (delegate* unmanaged<uint, nint, nint, void*, void>)QGL.GetGLProcAddress("glGetBufferSubDataARB");
        _glMapBufferARB = (delegate* unmanaged<uint, uint, void*>)QGL.GetGLProcAddress("glMapBufferARB");
        _glUnmapBufferARB = (delegate* unmanaged<uint, bool>)QGL.GetGLProcAddress("glUnmapBufferARB");
        _glGetBufferParameterivARB = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetBufferParameterivARB");
        _glGetBufferPointervARB = (delegate* unmanaged<uint, uint, void**, void>)QGL.GetGLProcAddress("glGetBufferPointervARB");
    }
