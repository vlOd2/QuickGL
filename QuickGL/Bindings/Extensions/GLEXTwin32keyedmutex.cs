...
public static unsafe class GLEXTwin32keyedmutex
{
    ...
    {
        _glAcquireKeyedMutexWin32EXT = (delegate* unmanaged<uint, ulong, uint, bool>)QGL.GetGLProcAddress("glAcquireKeyedMutexWin32EXT");
        _glReleaseKeyedMutexWin32EXT = (delegate* unmanaged<uint, ulong, bool>)QGL.GetGLProcAddress("glReleaseKeyedMutexWin32EXT");
    }
