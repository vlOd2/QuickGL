...
public static unsafe class GLEXTvertexarray
{
    ...
    {
        _glArrayElementEXT = (delegate* unmanaged<int, void>)QGL.GetGLProcAddress("glArrayElementEXT");
        _glColorPointerEXT = (delegate* unmanaged<int, uint, int, int, void*, void>)QGL.GetGLProcAddress("glColorPointerEXT");
        _glDrawArraysEXT = (delegate* unmanaged<uint, int, int, void>)QGL.GetGLProcAddress("glDrawArraysEXT");
        _glEdgeFlagPointerEXT = (delegate* unmanaged<int, int, bool*, void>)QGL.GetGLProcAddress("glEdgeFlagPointerEXT");
        _glGetPointervEXT = (delegate* unmanaged<uint, void**, void>)QGL.GetGLProcAddress("glGetPointervEXT");
        _glIndexPointerEXT = (delegate* unmanaged<uint, int, int, void*, void>)QGL.GetGLProcAddress("glIndexPointerEXT");
        _glNormalPointerEXT = (delegate* unmanaged<uint, int, int, void*, void>)QGL.GetGLProcAddress("glNormalPointerEXT");
        _glTexCoordPointerEXT = (delegate* unmanaged<int, uint, int, int, void*, void>)QGL.GetGLProcAddress("glTexCoordPointerEXT");
        _glVertexPointerEXT = (delegate* unmanaged<int, uint, int, int, void*, void>)QGL.GetGLProcAddress("glVertexPointerEXT");
    }
