...
public static unsafe class GLEXTmultidrawindirect
{
    ...
    {
        _glMultiDrawArraysIndirectEXT = (delegate* unmanaged<uint, void*, int, int, void>)QGL.GetGLProcAddress("glMultiDrawArraysIndirectEXT");
        _glMultiDrawElementsIndirectEXT = (delegate* unmanaged<uint, uint, void*, int, int, void>)QGL.GetGLProcAddress("glMultiDrawElementsIndirectEXT");
    }
