...
public static unsafe class GLEXThistogram
{
    ...
    {
        _glGetHistogramEXT = (delegate* unmanaged<uint, bool, uint, uint, void*, void>)QGL.GetGLProcAddress("glGetHistogramEXT");
        _glGetHistogramParameterfvEXT = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetHistogramParameterfvEXT");
        _glGetHistogramParameterivEXT = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetHistogramParameterivEXT");
        _glGetMinmaxEXT = (delegate* unmanaged<uint, bool, uint, uint, void*, void>)QGL.GetGLProcAddress("glGetMinmaxEXT");
        _glGetMinmaxParameterfvEXT = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetMinmaxParameterfvEXT");
        _glGetMinmaxParameterivEXT = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetMinmaxParameterivEXT");
        _glHistogramEXT = (delegate* unmanaged<uint, int, uint, bool, void>)QGL.GetGLProcAddress("glHistogramEXT");
        _glMinmaxEXT = (delegate* unmanaged<uint, uint, bool, void>)QGL.GetGLProcAddress("glMinmaxEXT");
        _glResetHistogramEXT = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glResetHistogramEXT");
        _glResetMinmaxEXT = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glResetMinmaxEXT");
    }
