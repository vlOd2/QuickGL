...
public static unsafe class GLEXTcoordinateframe
{
    ...
    {
        _glTangent3bEXT = (delegate* unmanaged<sbyte, sbyte, sbyte, void>)QGL.GetGLProcAddress("glTangent3bEXT");
        _glTangent3bvEXT = (delegate* unmanaged<sbyte*, void>)QGL.GetGLProcAddress("glTangent3bvEXT");
        _glTangent3dEXT = (delegate* unmanaged<double, double, double, void>)QGL.GetGLProcAddress("glTangent3dEXT");
        _glTangent3dvEXT = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glTangent3dvEXT");
        _glTangent3fEXT = (delegate* unmanaged<float, float, float, void>)QGL.GetGLProcAddress("glTangent3fEXT");
        _glTangent3fvEXT = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glTangent3fvEXT");
        _glTangent3iEXT = (delegate* unmanaged<int, int, int, void>)QGL.GetGLProcAddress("glTangent3iEXT");
        _glTangent3ivEXT = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glTangent3ivEXT");
        _glTangent3sEXT = (delegate* unmanaged<short, short, short, void>)QGL.GetGLProcAddress("glTangent3sEXT");
        _glTangent3svEXT = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glTangent3svEXT");
        _glBinormal3bEXT = (delegate* unmanaged<sbyte, sbyte, sbyte, void>)QGL.GetGLProcAddress("glBinormal3bEXT");
        _glBinormal3bvEXT = (delegate* unmanaged<sbyte*, void>)QGL.GetGLProcAddress("glBinormal3bvEXT");
        _glBinormal3dEXT = (delegate* unmanaged<double, double, double, void>)QGL.GetGLProcAddress("glBinormal3dEXT");
        _glBinormal3dvEXT = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glBinormal3dvEXT");
        _glBinormal3fEXT = (delegate* unmanaged<float, float, float, void>)QGL.GetGLProcAddress("glBinormal3fEXT");
        _glBinormal3fvEXT = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glBinormal3fvEXT");
        _glBinormal3iEXT = (delegate* unmanaged<int, int, int, void>)QGL.GetGLProcAddress("glBinormal3iEXT");
        _glBinormal3ivEXT = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glBinormal3ivEXT");
        _glBinormal3sEXT = (delegate* unmanaged<short, short, short, void>)QGL.GetGLProcAddress("glBinormal3sEXT");
        _glBinormal3svEXT = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glBinormal3svEXT");
        _glTangentPointerEXT = (delegate* unmanaged<uint, int, void*, void>)QGL.GetGLProcAddress("glTangentPointerEXT");
        _glBinormalPointerEXT = (delegate* unmanaged<uint, int, void*, void>)QGL.GetGLProcAddress("glBinormalPointerEXT");
    }
