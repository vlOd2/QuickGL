...
public static unsafe class GLARBvertexshader
{
    ...
    internal static void Load()
    {
        ...
        _glBindAttribLocationARB = (delegate* unmanaged<nint, uint, byte*, void>)QGL.GetGLProcAddress("glBindAttribLocationARB");
        _glGetActiveAttribARB = (delegate* unmanaged<nint, uint, int, int*, int*, uint*, byte*, void>)QGL.GetGLProcAddress("glGetActiveAttribARB");
        _glGetAttribLocationARB = (delegate* unmanaged<nint, byte*, int>)QGL.GetGLProcAddress("glGetAttribLocationARB");
