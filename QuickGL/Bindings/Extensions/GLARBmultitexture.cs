...
public static unsafe class GLARBmultitexture
{
    ...
    {
        _glActiveTextureARB = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glActiveTextureARB");
        _glClientActiveTextureARB = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glClientActiveTextureARB");
        _glMultiTexCoord1dARB = (delegate* unmanaged<uint, double, void>)QGL.GetGLProcAddress("glMultiTexCoord1dARB");
        _glMultiTexCoord1dvARB = (delegate* unmanaged<uint, double*, void>)QGL.GetGLProcAddress("glMultiTexCoord1dvARB");
        _glMultiTexCoord1fARB = (delegate* unmanaged<uint, float, void>)QGL.GetGLProcAddress("glMultiTexCoord1fARB");
        _glMultiTexCoord1fvARB = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glMultiTexCoord1fvARB");
        _glMultiTexCoord1iARB = (delegate* unmanaged<uint, int, void>)QGL.GetGLProcAddress("glMultiTexCoord1iARB");
        _glMultiTexCoord1ivARB = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glMultiTexCoord1ivARB");
        _glMultiTexCoord1sARB = (delegate* unmanaged<uint, short, void>)QGL.GetGLProcAddress("glMultiTexCoord1sARB");
        _glMultiTexCoord1svARB = (delegate* unmanaged<uint, short*, void>)QGL.GetGLProcAddress("glMultiTexCoord1svARB");
        _glMultiTexCoord2dARB = (delegate* unmanaged<uint, double, double, void>)QGL.GetGLProcAddress("glMultiTexCoord2dARB");
        _glMultiTexCoord2dvARB = (delegate* unmanaged<uint, double*, void>)QGL.GetGLProcAddress("glMultiTexCoord2dvARB");
        _glMultiTexCoord2fARB = (delegate* unmanaged<uint, float, float, void>)QGL.GetGLProcAddress("glMultiTexCoord2fARB");
        _glMultiTexCoord2fvARB = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glMultiTexCoord2fvARB");
        _glMultiTexCoord2iARB = (delegate* unmanaged<uint, int, int, void>)QGL.GetGLProcAddress("glMultiTexCoord2iARB");
        _glMultiTexCoord2ivARB = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glMultiTexCoord2ivARB");
        _glMultiTexCoord2sARB = (delegate* unmanaged<uint, short, short, void>)QGL.GetGLProcAddress("glMultiTexCoord2sARB");
        _glMultiTexCoord2svARB = (delegate* unmanaged<uint, short*, void>)QGL.GetGLProcAddress("glMultiTexCoord2svARB");
        _glMultiTexCoord3dARB = (delegate* unmanaged<uint, double, double, double, void>)QGL.GetGLProcAddress("glMultiTexCoord3dARB");
        _glMultiTexCoord3dvARB = (delegate* unmanaged<uint, double*, void>)QGL.GetGLProcAddress("glMultiTexCoord3dvARB");
        _glMultiTexCoord3fARB = (delegate* unmanaged<uint, float, float, float, void>)QGL.GetGLProcAddress("glMultiTexCoord3fARB");
        _glMultiTexCoord3fvARB = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glMultiTexCoord3fvARB");
        _glMultiTexCoord3iARB = (delegate* unmanaged<uint, int, int, int, void>)QGL.GetGLProcAddress("glMultiTexCoord3iARB");
        _glMultiTexCoord3ivARB = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glMultiTexCoord3ivARB");
        _glMultiTexCoord3sARB = (delegate* unmanaged<uint, short, short, short, void>)QGL.GetGLProcAddress("glMultiTexCoord3sARB");
        _glMultiTexCoord3svARB = (delegate* unmanaged<uint, short*, void>)QGL.GetGLProcAddress("glMultiTexCoord3svARB");
        _glMultiTexCoord4dARB = (delegate* unmanaged<uint, double, double, double, double, void>)QGL.GetGLProcAddress("glMultiTexCoord4dARB");
        _glMultiTexCoord4dvARB = (delegate* unmanaged<uint, double*, void>)QGL.GetGLProcAddress("glMultiTexCoord4dvARB");
        _glMultiTexCoord4fARB = (delegate* unmanaged<uint, float, float, float, float, void>)QGL.GetGLProcAddress("glMultiTexCoord4fARB");
        _glMultiTexCoord4fvARB = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glMultiTexCoord4fvARB");
        _glMultiTexCoord4iARB = (delegate* unmanaged<uint, int, int, int, int, void>)QGL.GetGLProcAddress("glMultiTexCoord4iARB");
        _glMultiTexCoord4ivARB = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glMultiTexCoord4ivARB");
        _glMultiTexCoord4sARB = (delegate* unmanaged<uint, short, short, short, short, void>)QGL.GetGLProcAddress("glMultiTexCoord4sARB");
        _glMultiTexCoord4svARB = (delegate* unmanaged<uint, short*, void>)QGL.GetGLProcAddress("glMultiTexCoord4svARB");
    }
