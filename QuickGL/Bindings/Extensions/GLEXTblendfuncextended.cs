...
public static unsafe class GLEXTblendfuncextended
{
    ...
    {
        _glBindFragDataLocationIndexedEXT = (delegate* unmanaged<uint, uint, uint, byte*, void>)QGL.GetGLProcAddress("glBindFragDataLocationIndexedEXT");
        _glBindFragDataLocationEXT = (delegate* unmanaged<uint, uint, byte*, void>)QGL.GetGLProcAddress("glBindFragDataLocationEXT");
        _glGetProgramResourceLocationIndexEXT = (delegate* unmanaged<uint, uint, byte*, int>)QGL.GetGLProcAddress("glGetProgramResourceLocationIndexEXT");
        _glGetFragDataIndexEXT = (delegate* unmanaged<uint, byte*, int>)QGL.GetGLProcAddress("glGetFragDataIndexEXT");
    }
