...
// Generated at: 2025-09-27T19:00:38.1720346Z
...
public static unsafe class GLEXTtransformfeedback
{
    ...
    internal static delegate* unmanaged<uint, int, nint, uint, void> _glTransformFeedbackVaryingsEXT = null;
    ...
    internal static void Load()
    {
        ...
        _glTransformFeedbackVaryingsEXT = (delegate* unmanaged<uint, int, nint, uint, void>)QuickGL.GetGLProcAddress("glTransformFeedbackVaryingsEXT");
    ...
    public static void glTransformFeedbackVaryingsEXT(uint program, int count, nint varyings, uint bufferMode) { QGLFeature.VerifyFunc((nint)_glTransformFeedbackVaryingsEXT); _glTransformFeedbackVaryingsEXT(program, count, varyings, bufferMode); }
