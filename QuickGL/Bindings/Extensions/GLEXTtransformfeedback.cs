...
public static unsafe class GLEXTtransformfeedback
{
    ...
    {
        _glBeginTransformFeedbackEXT = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glBeginTransformFeedbackEXT");
        _glEndTransformFeedbackEXT = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glEndTransformFeedbackEXT");
        _glBindBufferRangeEXT = (delegate* unmanaged<uint, uint, uint, nint, nint, void>)QGL.GetGLProcAddress("glBindBufferRangeEXT");
        _glBindBufferOffsetEXT = (delegate* unmanaged<uint, uint, uint, nint, void>)QGL.GetGLProcAddress("glBindBufferOffsetEXT");
        _glBindBufferBaseEXT = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glBindBufferBaseEXT");
        _glTransformFeedbackVaryingsEXT = (delegate* unmanaged<uint, int, byte**, uint, void>)QGL.GetGLProcAddress("glTransformFeedbackVaryingsEXT");
        _glGetTransformFeedbackVaryingEXT = (delegate* unmanaged<uint, uint, int, int*, int*, uint*, byte*, void>)QGL.GetGLProcAddress("glGetTransformFeedbackVaryingEXT");
    }
