...
public static unsafe class GLEXTmultisample
{
    ...
    {
        _glSampleMaskEXT = (delegate* unmanaged<float, bool, void>)QGL.GetGLProcAddress("glSampleMaskEXT");
        _glSamplePatternEXT = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glSamplePatternEXT");
    }
