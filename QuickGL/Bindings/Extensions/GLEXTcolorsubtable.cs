...
public static unsafe class GLEXTcolorsubtable
{
    ...
    {
        _glColorSubTableEXT = (delegate* unmanaged<uint, int, int, uint, uint, void*, void>)QGL.GetGLProcAddress("glColorSubTableEXT");
        _glCopyColorSubTableEXT = (delegate* unmanaged<uint, int, int, int, int, void>)QGL.GetGLProcAddress("glCopyColorSubTableEXT");
    }
