...
public static unsafe class GLARBwindowpos
{
    ...
    {
        _glWindowPos2dARB = (delegate* unmanaged<double, double, void>)QGL.GetGLProcAddress("glWindowPos2dARB");
        _glWindowPos2dvARB = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glWindowPos2dvARB");
        _glWindowPos2fARB = (delegate* unmanaged<float, float, void>)QGL.GetGLProcAddress("glWindowPos2fARB");
        _glWindowPos2fvARB = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glWindowPos2fvARB");
        _glWindowPos2iARB = (delegate* unmanaged<int, int, void>)QGL.GetGLProcAddress("glWindowPos2iARB");
        _glWindowPos2ivARB = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glWindowPos2ivARB");
        _glWindowPos2sARB = (delegate* unmanaged<short, short, void>)QGL.GetGLProcAddress("glWindowPos2sARB");
        _glWindowPos2svARB = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glWindowPos2svARB");
        _glWindowPos3dARB = (delegate* unmanaged<double, double, double, void>)QGL.GetGLProcAddress("glWindowPos3dARB");
        _glWindowPos3dvARB = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glWindowPos3dvARB");
        _glWindowPos3fARB = (delegate* unmanaged<float, float, float, void>)QGL.GetGLProcAddress("glWindowPos3fARB");
        _glWindowPos3fvARB = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glWindowPos3fvARB");
        _glWindowPos3iARB = (delegate* unmanaged<int, int, int, void>)QGL.GetGLProcAddress("glWindowPos3iARB");
        _glWindowPos3ivARB = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glWindowPos3ivARB");
        _glWindowPos3sARB = (delegate* unmanaged<short, short, short, void>)QGL.GetGLProcAddress("glWindowPos3sARB");
        _glWindowPos3svARB = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glWindowPos3svARB");
    }
