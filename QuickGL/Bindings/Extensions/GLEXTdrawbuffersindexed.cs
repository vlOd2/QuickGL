...
public static unsafe class GLEXTdrawbuffersindexed
{
    ...
    {
        _glEnableiEXT = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glEnableiEXT");
        _glDisableiEXT = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glDisableiEXT");
        _glBlendEquationiEXT = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glBlendEquationiEXT");
        _glBlendEquationSeparateiEXT = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glBlendEquationSeparateiEXT");
        _glBlendFunciEXT = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glBlendFunciEXT");
        _glBlendFuncSeparateiEXT = (delegate* unmanaged<uint, uint, uint, uint, uint, void>)QGL.GetGLProcAddress("glBlendFuncSeparateiEXT");
        _glColorMaskiEXT = (delegate* unmanaged<uint, bool, bool, bool, bool, void>)QGL.GetGLProcAddress("glColorMaskiEXT");
        _glIsEnablediEXT = (delegate* unmanaged<uint, uint, bool>)QGL.GetGLProcAddress("glIsEnablediEXT");
    }
