...
public static unsafe class GLARBshadinglanguageinclude
{
    ...
    {
        _glNamedStringARB = (delegate* unmanaged<uint, int, byte*, int, byte*, void>)QGL.GetGLProcAddress("glNamedStringARB");
        _glDeleteNamedStringARB = (delegate* unmanaged<int, byte*, void>)QGL.GetGLProcAddress("glDeleteNamedStringARB");
        _glCompileShaderIncludeARB = (delegate* unmanaged<uint, int, byte**, int*, void>)QGL.GetGLProcAddress("glCompileShaderIncludeARB");
        _glIsNamedStringARB = (delegate* unmanaged<int, byte*, bool>)QGL.GetGLProcAddress("glIsNamedStringARB");
        _glGetNamedStringARB = (delegate* unmanaged<int, byte*, int, int*, byte*, void>)QGL.GetGLProcAddress("glGetNamedStringARB");
        _glGetNamedStringivARB = (delegate* unmanaged<int, byte*, uint, int*, void>)QGL.GetGLProcAddress("glGetNamedStringivARB");
    }
