...
public static unsafe class GLARBvertexprogram
{
    ...
    {
        _glVertexAttrib1dARB = (delegate* unmanaged<uint, double, void>)QGL.GetGLProcAddress("glVertexAttrib1dARB");
        _glVertexAttrib1dvARB = (delegate* unmanaged<uint, double*, void>)QGL.GetGLProcAddress("glVertexAttrib1dvARB");
        _glVertexAttrib1fARB = (delegate* unmanaged<uint, float, void>)QGL.GetGLProcAddress("glVertexAttrib1fARB");
        _glVertexAttrib1fvARB = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glVertexAttrib1fvARB");
        _glVertexAttrib1sARB = (delegate* unmanaged<uint, short, void>)QGL.GetGLProcAddress("glVertexAttrib1sARB");
        _glVertexAttrib1svARB = (delegate* unmanaged<uint, short*, void>)QGL.GetGLProcAddress("glVertexAttrib1svARB");
        _glVertexAttrib2dARB = (delegate* unmanaged<uint, double, double, void>)QGL.GetGLProcAddress("glVertexAttrib2dARB");
        _glVertexAttrib2dvARB = (delegate* unmanaged<uint, double*, void>)QGL.GetGLProcAddress("glVertexAttrib2dvARB");
        _glVertexAttrib2fARB = (delegate* unmanaged<uint, float, float, void>)QGL.GetGLProcAddress("glVertexAttrib2fARB");
        _glVertexAttrib2fvARB = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glVertexAttrib2fvARB");
        _glVertexAttrib2sARB = (delegate* unmanaged<uint, short, short, void>)QGL.GetGLProcAddress("glVertexAttrib2sARB");
        _glVertexAttrib2svARB = (delegate* unmanaged<uint, short*, void>)QGL.GetGLProcAddress("glVertexAttrib2svARB");
        _glVertexAttrib3dARB = (delegate* unmanaged<uint, double, double, double, void>)QGL.GetGLProcAddress("glVertexAttrib3dARB");
        _glVertexAttrib3dvARB = (delegate* unmanaged<uint, double*, void>)QGL.GetGLProcAddress("glVertexAttrib3dvARB");
        _glVertexAttrib3fARB = (delegate* unmanaged<uint, float, float, float, void>)QGL.GetGLProcAddress("glVertexAttrib3fARB");
        _glVertexAttrib3fvARB = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glVertexAttrib3fvARB");
        _glVertexAttrib3sARB = (delegate* unmanaged<uint, short, short, short, void>)QGL.GetGLProcAddress("glVertexAttrib3sARB");
        _glVertexAttrib3svARB = (delegate* unmanaged<uint, short*, void>)QGL.GetGLProcAddress("glVertexAttrib3svARB");
        _glVertexAttrib4NbvARB = (delegate* unmanaged<uint, sbyte*, void>)QGL.GetGLProcAddress("glVertexAttrib4NbvARB");
        _glVertexAttrib4NivARB = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glVertexAttrib4NivARB");
        _glVertexAttrib4NsvARB = (delegate* unmanaged<uint, short*, void>)QGL.GetGLProcAddress("glVertexAttrib4NsvARB");
        _glVertexAttrib4NubARB = (delegate* unmanaged<uint, byte, byte, byte, byte, void>)QGL.GetGLProcAddress("glVertexAttrib4NubARB");
        _glVertexAttrib4NubvARB = (delegate* unmanaged<uint, byte*, void>)QGL.GetGLProcAddress("glVertexAttrib4NubvARB");
        _glVertexAttrib4NuivARB = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glVertexAttrib4NuivARB");
        _glVertexAttrib4NusvARB = (delegate* unmanaged<uint, ushort*, void>)QGL.GetGLProcAddress("glVertexAttrib4NusvARB");
        _glVertexAttrib4bvARB = (delegate* unmanaged<uint, sbyte*, void>)QGL.GetGLProcAddress("glVertexAttrib4bvARB");
        _glVertexAttrib4dARB = (delegate* unmanaged<uint, double, double, double, double, void>)QGL.GetGLProcAddress("glVertexAttrib4dARB");
        _glVertexAttrib4dvARB = (delegate* unmanaged<uint, double*, void>)QGL.GetGLProcAddress("glVertexAttrib4dvARB");
        _glVertexAttrib4fARB = (delegate* unmanaged<uint, float, float, float, float, void>)QGL.GetGLProcAddress("glVertexAttrib4fARB");
        _glVertexAttrib4fvARB = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glVertexAttrib4fvARB");
        _glVertexAttrib4ivARB = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glVertexAttrib4ivARB");
        _glVertexAttrib4sARB = (delegate* unmanaged<uint, short, short, short, short, void>)QGL.GetGLProcAddress("glVertexAttrib4sARB");
        _glVertexAttrib4svARB = (delegate* unmanaged<uint, short*, void>)QGL.GetGLProcAddress("glVertexAttrib4svARB");
        _glVertexAttrib4ubvARB = (delegate* unmanaged<uint, byte*, void>)QGL.GetGLProcAddress("glVertexAttrib4ubvARB");
        _glVertexAttrib4uivARB = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glVertexAttrib4uivARB");
        _glVertexAttrib4usvARB = (delegate* unmanaged<uint, ushort*, void>)QGL.GetGLProcAddress("glVertexAttrib4usvARB");
        _glVertexAttribPointerARB = (delegate* unmanaged<uint, int, uint, bool, int, void*, void>)QGL.GetGLProcAddress("glVertexAttribPointerARB");
        _glEnableVertexAttribArrayARB = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glEnableVertexAttribArrayARB");
        _glDisableVertexAttribArrayARB = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glDisableVertexAttribArrayARB");
        ...
        _glGetVertexAttribdvARB = (delegate* unmanaged<uint, uint, double*, void>)QGL.GetGLProcAddress("glGetVertexAttribdvARB");
        _glGetVertexAttribfvARB = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetVertexAttribfvARB");
        _glGetVertexAttribivARB = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetVertexAttribivARB");
        _glGetVertexAttribPointervARB = (delegate* unmanaged<uint, uint, void**, void>)QGL.GetGLProcAddress("glGetVertexAttribPointervARB");
