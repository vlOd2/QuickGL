...
public static unsafe class GLARBtexturecompression
{
    ...
    {
        _glCompressedTexImage3DARB = (delegate* unmanaged<uint, int, uint, int, int, int, int, int, void*, void>)QGL.GetGLProcAddress("glCompressedTexImage3DARB");
        _glCompressedTexImage2DARB = (delegate* unmanaged<uint, int, uint, int, int, int, int, void*, void>)QGL.GetGLProcAddress("glCompressedTexImage2DARB");
        _glCompressedTexImage1DARB = (delegate* unmanaged<uint, int, uint, int, int, int, void*, void>)QGL.GetGLProcAddress("glCompressedTexImage1DARB");
        _glCompressedTexSubImage3DARB = (delegate* unmanaged<uint, int, int, int, int, int, int, int, uint, int, void*, void>)QGL.GetGLProcAddress("glCompressedTexSubImage3DARB");
        _glCompressedTexSubImage2DARB = (delegate* unmanaged<uint, int, int, int, int, int, uint, int, void*, void>)QGL.GetGLProcAddress("glCompressedTexSubImage2DARB");
        _glCompressedTexSubImage1DARB = (delegate* unmanaged<uint, int, int, int, uint, int, void*, void>)QGL.GetGLProcAddress("glCompressedTexSubImage1DARB");
        _glGetCompressedTexImageARB = (delegate* unmanaged<uint, int, void*, void>)QGL.GetGLProcAddress("glGetCompressedTexImageARB");
    }
