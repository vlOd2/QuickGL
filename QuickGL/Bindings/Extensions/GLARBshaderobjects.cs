...
public static unsafe class GLARBshaderobjects
{
    ...
    {
        _glDeleteObjectARB = (delegate* unmanaged<nint, void>)QGL.GetGLProcAddress("glDeleteObjectARB");
        _glGetHandleARB = (delegate* unmanaged<uint, nint>)QGL.GetGLProcAddress("glGetHandleARB");
        _glDetachObjectARB = (delegate* unmanaged<nint, nint, void>)QGL.GetGLProcAddress("glDetachObjectARB");
        _glCreateShaderObjectARB = (delegate* unmanaged<uint, nint>)QGL.GetGLProcAddress("glCreateShaderObjectARB");
        _glShaderSourceARB = (delegate* unmanaged<nint, int, byte**, int*, void>)QGL.GetGLProcAddress("glShaderSourceARB");
        _glCompileShaderARB = (delegate* unmanaged<nint, void>)QGL.GetGLProcAddress("glCompileShaderARB");
        _glCreateProgramObjectARB = (delegate* unmanaged<nint>)QGL.GetGLProcAddress("glCreateProgramObjectARB");
        _glAttachObjectARB = (delegate* unmanaged<nint, nint, void>)QGL.GetGLProcAddress("glAttachObjectARB");
        _glLinkProgramARB = (delegate* unmanaged<nint, void>)QGL.GetGLProcAddress("glLinkProgramARB");
        _glUseProgramObjectARB = (delegate* unmanaged<nint, void>)QGL.GetGLProcAddress("glUseProgramObjectARB");
        _glValidateProgramARB = (delegate* unmanaged<nint, void>)QGL.GetGLProcAddress("glValidateProgramARB");
        _glUniform1fARB = (delegate* unmanaged<int, float, void>)QGL.GetGLProcAddress("glUniform1fARB");
        _glUniform2fARB = (delegate* unmanaged<int, float, float, void>)QGL.GetGLProcAddress("glUniform2fARB");
        _glUniform3fARB = (delegate* unmanaged<int, float, float, float, void>)QGL.GetGLProcAddress("glUniform3fARB");
        _glUniform4fARB = (delegate* unmanaged<int, float, float, float, float, void>)QGL.GetGLProcAddress("glUniform4fARB");
        _glUniform1iARB = (delegate* unmanaged<int, int, void>)QGL.GetGLProcAddress("glUniform1iARB");
        _glUniform2iARB = (delegate* unmanaged<int, int, int, void>)QGL.GetGLProcAddress("glUniform2iARB");
        _glUniform3iARB = (delegate* unmanaged<int, int, int, int, void>)QGL.GetGLProcAddress("glUniform3iARB");
        _glUniform4iARB = (delegate* unmanaged<int, int, int, int, int, void>)QGL.GetGLProcAddress("glUniform4iARB");
        _glUniform1fvARB = (delegate* unmanaged<int, int, float*, void>)QGL.GetGLProcAddress("glUniform1fvARB");
        _glUniform2fvARB = (delegate* unmanaged<int, int, float*, void>)QGL.GetGLProcAddress("glUniform2fvARB");
        _glUniform3fvARB = (delegate* unmanaged<int, int, float*, void>)QGL.GetGLProcAddress("glUniform3fvARB");
        _glUniform4fvARB = (delegate* unmanaged<int, int, float*, void>)QGL.GetGLProcAddress("glUniform4fvARB");
        _glUniform1ivARB = (delegate* unmanaged<int, int, int*, void>)QGL.GetGLProcAddress("glUniform1ivARB");
        _glUniform2ivARB = (delegate* unmanaged<int, int, int*, void>)QGL.GetGLProcAddress("glUniform2ivARB");
        _glUniform3ivARB = (delegate* unmanaged<int, int, int*, void>)QGL.GetGLProcAddress("glUniform3ivARB");
        _glUniform4ivARB = (delegate* unmanaged<int, int, int*, void>)QGL.GetGLProcAddress("glUniform4ivARB");
        _glUniformMatrix2fvARB = (delegate* unmanaged<int, int, bool, float*, void>)QGL.GetGLProcAddress("glUniformMatrix2fvARB");
        _glUniformMatrix3fvARB = (delegate* unmanaged<int, int, bool, float*, void>)QGL.GetGLProcAddress("glUniformMatrix3fvARB");
        _glUniformMatrix4fvARB = (delegate* unmanaged<int, int, bool, float*, void>)QGL.GetGLProcAddress("glUniformMatrix4fvARB");
        _glGetObjectParameterfvARB = (delegate* unmanaged<nint, uint, float*, void>)QGL.GetGLProcAddress("glGetObjectParameterfvARB");
        _glGetObjectParameterivARB = (delegate* unmanaged<nint, uint, int*, void>)QGL.GetGLProcAddress("glGetObjectParameterivARB");
        _glGetInfoLogARB = (delegate* unmanaged<nint, int, int*, byte*, void>)QGL.GetGLProcAddress("glGetInfoLogARB");
        _glGetAttachedObjectsARB = (delegate* unmanaged<nint, int, int*, nint, void>)QGL.GetGLProcAddress("glGetAttachedObjectsARB");
        _glGetUniformLocationARB = (delegate* unmanaged<nint, byte*, int>)QGL.GetGLProcAddress("glGetUniformLocationARB");
        _glGetActiveUniformARB = (delegate* unmanaged<nint, uint, int, int*, int*, uint*, byte*, void>)QGL.GetGLProcAddress("glGetActiveUniformARB");
        _glGetUniformfvARB = (delegate* unmanaged<nint, int, float*, void>)QGL.GetGLProcAddress("glGetUniformfvARB");
        _glGetUniformivARB = (delegate* unmanaged<nint, int, int*, void>)QGL.GetGLProcAddress("glGetUniformivARB");
        _glGetShaderSourceARB = (delegate* unmanaged<nint, int, int*, byte*, void>)QGL.GetGLProcAddress("glGetShaderSourceARB");
    }
