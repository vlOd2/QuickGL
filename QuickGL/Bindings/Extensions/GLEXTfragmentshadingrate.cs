...
public static unsafe class GLEXTfragmentshadingrate
{
    ...
    {
        _glGetFragmentShadingRatesEXT = (delegate* unmanaged<int, int, int*, uint*, void>)QGL.GetGLProcAddress("glGetFragmentShadingRatesEXT");
        _glShadingRateEXT = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glShadingRateEXT");
        _glShadingRateCombinerOpsEXT = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glShadingRateCombinerOpsEXT");
        _glFramebufferShadingRateEXT = (delegate* unmanaged<uint, uint, uint, int, int, int, int, void>)QGL.GetGLProcAddress("glFramebufferShadingRateEXT");
    }
