...
// Generated at: 2025-09-27T19:00:35.5380564Z
...
public static unsafe class GLFW
{
    ...
    public const float GLFW_KEY_UNKNOWN = -1;
    ...
    public const float GLFW_DONT_CARE = -1;
    ...
    internal static delegate* unmanaged<GLFWwindow*, int, nint, void> _glfwSetWindowIcon = null;
    ...
    internal static delegate* unmanaged<nint, int, int, GLFWcursor*> _glfwCreateCursor = null;
    ...
    internal static void Load()
    {
        ...
        _glfwSetWindowIcon = (delegate* unmanaged<GLFWwindow*, int, nint, void>)QuickGL.GetGLFWProcAddress("glfwSetWindowIcon");
        ...
        _glfwCreateCursor = (delegate* unmanaged<nint, int, int, GLFWcursor*>)QuickGL.GetGLFWProcAddress("glfwCreateCursor");
    ...
    public static void glfwSetWindowIcon(GLFWwindow* window, int count, nint images) { QGLFeature.VerifyFunc((nint)_glfwSetWindowIcon); _glfwSetWindowIcon(window, count, images); }
    ...
    public static GLFWcursor* glfwCreateCursor(nint image, int xhot, int yhot) { QGLFeature.VerifyFunc((nint)_glfwCreateCursor); return _glfwCreateCursor(image, xhot, yhot); }
