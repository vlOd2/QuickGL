...
public static unsafe class GL43
{
    ...
    internal static void Load()
    {
        ...
        _glDispatchCompute = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glDispatchCompute");
        _glDispatchComputeIndirect = (delegate* unmanaged<nint, void>)QGL.GetGLProcAddress("glDispatchComputeIndirect");
        _glCopyImageSubData = (delegate* unmanaged<uint, uint, int, int, int, int, uint, uint, int, int, int, int, int, int, int, void>)QGL.GetGLProcAddress("glCopyImageSubData");
        ...
        _glGetInternalformati64v = (delegate* unmanaged<uint, uint, uint, int, long*, void>)QGL.GetGLProcAddress("glGetInternalformati64v");
        ...
        _glGetProgramInterfaceiv = (delegate* unmanaged<uint, uint, uint, int*, void>)QGL.GetGLProcAddress("glGetProgramInterfaceiv");
        _glGetProgramResourceIndex = (delegate* unmanaged<uint, uint, byte*, uint>)QGL.GetGLProcAddress("glGetProgramResourceIndex");
        _glGetProgramResourceName = (delegate* unmanaged<uint, uint, uint, int, int*, byte*, void>)QGL.GetGLProcAddress("glGetProgramResourceName");
        _glGetProgramResourceiv = (delegate* unmanaged<uint, uint, uint, int, uint*, int, int*, int*, void>)QGL.GetGLProcAddress("glGetProgramResourceiv");
        _glGetProgramResourceLocation = (delegate* unmanaged<uint, uint, byte*, int>)QGL.GetGLProcAddress("glGetProgramResourceLocation");
        _glGetProgramResourceLocationIndex = (delegate* unmanaged<uint, uint, byte*, int>)QGL.GetGLProcAddress("glGetProgramResourceLocationIndex");
        _glShaderStorageBlockBinding = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glShaderStorageBlockBinding");
        _glTexBufferRange = (delegate* unmanaged<uint, uint, uint, nint, nint, void>)QGL.GetGLProcAddress("glTexBufferRange");
        _glTexStorage2DMultisample = (delegate* unmanaged<uint, int, uint, int, int, bool, void>)QGL.GetGLProcAddress("glTexStorage2DMultisample");
        _glTexStorage3DMultisample = (delegate* unmanaged<uint, int, uint, int, int, int, bool, void>)QGL.GetGLProcAddress("glTexStorage3DMultisample");
        _glTextureView = (delegate* unmanaged<uint, uint, uint, uint, uint, uint, uint, uint, void>)QGL.GetGLProcAddress("glTextureView");
        _glBindVertexBuffer = (delegate* unmanaged<uint, uint, nint, int, void>)QGL.GetGLProcAddress("glBindVertexBuffer");
        _glVertexAttribFormat = (delegate* unmanaged<uint, int, uint, bool, uint, void>)QGL.GetGLProcAddress("glVertexAttribFormat");
        _glVertexAttribIFormat = (delegate* unmanaged<uint, int, uint, uint, void>)QGL.GetGLProcAddress("glVertexAttribIFormat");
        _glVertexAttribLFormat = (delegate* unmanaged<uint, int, uint, uint, void>)QGL.GetGLProcAddress("glVertexAttribLFormat");
        _glVertexAttribBinding = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glVertexAttribBinding");
        _glVertexBindingDivisor = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glVertexBindingDivisor");
        _glDebugMessageControl = (delegate* unmanaged<uint, uint, uint, int, uint*, bool, void>)QGL.GetGLProcAddress("glDebugMessageControl");
        _glDebugMessageInsert = (delegate* unmanaged<uint, uint, uint, uint, int, byte*, void>)QGL.GetGLProcAddress("glDebugMessageInsert");
        _glDebugMessageCallback = (delegate* unmanaged<nint, void*, void>)QGL.GetGLProcAddress("glDebugMessageCallback");
        _glGetDebugMessageLog = (delegate* unmanaged<uint, int, uint*, uint*, uint*, uint*, int*, byte*, uint>)QGL.GetGLProcAddress("glGetDebugMessageLog");
        _glPushDebugGroup = (delegate* unmanaged<uint, uint, int, byte*, void>)QGL.GetGLProcAddress("glPushDebugGroup");
        _glPopDebugGroup = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glPopDebugGroup");
        _glObjectLabel = (delegate* unmanaged<uint, uint, int, byte*, void>)QGL.GetGLProcAddress("glObjectLabel");
        _glGetObjectLabel = (delegate* unmanaged<uint, uint, int, int*, byte*, void>)QGL.GetGLProcAddress("glGetObjectLabel");
        _glObjectPtrLabel = (delegate* unmanaged<void*, int, byte*, void>)QGL.GetGLProcAddress("glObjectPtrLabel");
        _glGetObjectPtrLabel = (delegate* unmanaged<void*, int, int*, byte*, void>)QGL.GetGLProcAddress("glGetObjectPtrLabel");
        _glGetPointerv = (delegate* unmanaged<uint, void**, void>)QGL.GetGLProcAddress("glGetPointerv");
    }
