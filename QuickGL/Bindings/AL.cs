...
[UnmanagedFunctionPointer(CallingConvention.Winapi)]
public unsafe delegate void LPALGETBOOLEANV(int param, bool* values);
...
[UnmanagedFunctionPointer(CallingConvention.Winapi)]
public unsafe delegate bool LPALGETBOOLEAN(int param);
...
[UnmanagedFunctionPointer(CallingConvention.Winapi)]
public unsafe delegate bool LPALISEXTENSIONPRESENT(byte* extname);
...
[UnmanagedFunctionPointer(CallingConvention.Winapi)]
public unsafe delegate bool LPALISSOURCE(uint source);
...
[UnmanagedFunctionPointer(CallingConvention.Winapi)]
public unsafe delegate bool LPALISBUFFER(uint buffer);
...
public static unsafe class AL
{
    ...
    internal static delegate* unmanaged<int, bool> _alGetBoolean = null;
    ...
    internal static delegate* unmanaged<byte*, bool> _alIsExtensionPresent = null;
    ...
    internal static delegate* unmanaged<uint, bool> _alIsSource = null;
    ...
    internal static delegate* unmanaged<uint, bool> _alIsBuffer = null;
    ...
    {
        _alEnable = (delegate* unmanaged<int, void>)QGL.GetALProcAddress("alEnable");
        _alDisable = (delegate* unmanaged<int, void>)QGL.GetALProcAddress("alDisable");
        _alIsEnabled = (delegate* unmanaged<int, bool>)QGL.GetALProcAddress("alIsEnabled");
        _alDopplerFactor = (delegate* unmanaged<float, void>)QGL.GetALProcAddress("alDopplerFactor");
        _alDopplerVelocity = (delegate* unmanaged<float, void>)QGL.GetALProcAddress("alDopplerVelocity");
        _alDistanceModel = (delegate* unmanaged<int, void>)QGL.GetALProcAddress("alDistanceModel");
        _alGetString = (delegate* unmanaged<int, byte*>)QGL.GetALProcAddress("alGetString");
        _alGetBooleanv = (delegate* unmanaged<int, bool*, void>)QGL.GetALProcAddress("alGetBooleanv");
        _alGetIntegerv = (delegate* unmanaged<int, int*, void>)QGL.GetALProcAddress("alGetIntegerv");
        _alGetFloatv = (delegate* unmanaged<int, float*, void>)QGL.GetALProcAddress("alGetFloatv");
        _alGetDoublev = (delegate* unmanaged<int, double*, void>)QGL.GetALProcAddress("alGetDoublev");
        _alGetBoolean = (delegate* unmanaged<int, bool>)QGL.GetALProcAddress("alGetBoolean");
        _alGetInteger = (delegate* unmanaged<int, int>)QGL.GetALProcAddress("alGetInteger");
        _alGetFloat = (delegate* unmanaged<int, float>)QGL.GetALProcAddress("alGetFloat");
        _alGetDouble = (delegate* unmanaged<int, double>)QGL.GetALProcAddress("alGetDouble");
        _alGetError = (delegate* unmanaged<int>)QGL.GetALProcAddress("alGetError");
        _alIsExtensionPresent = (delegate* unmanaged<byte*, bool>)QGL.GetALProcAddress("alIsExtensionPresent");
        _alGetProcAddress = (delegate* unmanaged<byte*, void*>)QGL.GetALProcAddress("alGetProcAddress");
        _alGetEnumValue = (delegate* unmanaged<byte*, int>)QGL.GetALProcAddress("alGetEnumValue");
        _alListenerf = (delegate* unmanaged<int, float, void>)QGL.GetALProcAddress("alListenerf");
        _alListener3f = (delegate* unmanaged<int, float, float, float, void>)QGL.GetALProcAddress("alListener3f");
        _alListenerfv = (delegate* unmanaged<int, float*, void>)QGL.GetALProcAddress("alListenerfv");
        _alListeneri = (delegate* unmanaged<int, int, void>)QGL.GetALProcAddress("alListeneri");
        _alListener3i = (delegate* unmanaged<int, int, int, int, void>)QGL.GetALProcAddress("alListener3i");
        _alListeneriv = (delegate* unmanaged<int, int*, void>)QGL.GetALProcAddress("alListeneriv");
        _alGetListenerf = (delegate* unmanaged<int, float*, void>)QGL.GetALProcAddress("alGetListenerf");
        _alGetListener3f = (delegate* unmanaged<int, float*, float*, float*, void>)QGL.GetALProcAddress("alGetListener3f");
        _alGetListenerfv = (delegate* unmanaged<int, float*, void>)QGL.GetALProcAddress("alGetListenerfv");
        _alGetListeneri = (delegate* unmanaged<int, int*, void>)QGL.GetALProcAddress("alGetListeneri");
        _alGetListener3i = (delegate* unmanaged<int, int*, int*, int*, void>)QGL.GetALProcAddress("alGetListener3i");
        _alGetListeneriv = (delegate* unmanaged<int, int*, void>)QGL.GetALProcAddress("alGetListeneriv");
        _alGenSources = (delegate* unmanaged<int, uint*, void>)QGL.GetALProcAddress("alGenSources");
        _alDeleteSources = (delegate* unmanaged<int, uint*, void>)QGL.GetALProcAddress("alDeleteSources");
        _alIsSource = (delegate* unmanaged<uint, bool>)QGL.GetALProcAddress("alIsSource");
        _alSourcef = (delegate* unmanaged<uint, int, float, void>)QGL.GetALProcAddress("alSourcef");
        _alSource3f = (delegate* unmanaged<uint, int, float, float, float, void>)QGL.GetALProcAddress("alSource3f");
        _alSourcefv = (delegate* unmanaged<uint, int, float*, void>)QGL.GetALProcAddress("alSourcefv");
        _alSourcei = (delegate* unmanaged<uint, int, int, void>)QGL.GetALProcAddress("alSourcei");
        _alSource3i = (delegate* unmanaged<uint, int, int, int, int, void>)QGL.GetALProcAddress("alSource3i");
        _alSourceiv = (delegate* unmanaged<uint, int, int*, void>)QGL.GetALProcAddress("alSourceiv");
        _alGetSourcef = (delegate* unmanaged<uint, int, float*, void>)QGL.GetALProcAddress("alGetSourcef");
        _alGetSource3f = (delegate* unmanaged<uint, int, float*, float*, float*, void>)QGL.GetALProcAddress("alGetSource3f");
        _alGetSourcefv = (delegate* unmanaged<uint, int, float*, void>)QGL.GetALProcAddress("alGetSourcefv");
        _alGetSourcei = (delegate* unmanaged<uint, int, int*, void>)QGL.GetALProcAddress("alGetSourcei");
        _alGetSource3i = (delegate* unmanaged<uint, int, int*, int*, int*, void>)QGL.GetALProcAddress("alGetSource3i");
        _alGetSourceiv = (delegate* unmanaged<uint, int, int*, void>)QGL.GetALProcAddress("alGetSourceiv");
        _alSourcePlay = (delegate* unmanaged<uint, void>)QGL.GetALProcAddress("alSourcePlay");
        _alSourceStop = (delegate* unmanaged<uint, void>)QGL.GetALProcAddress("alSourceStop");
        _alSourceRewind = (delegate* unmanaged<uint, void>)QGL.GetALProcAddress("alSourceRewind");
        _alSourcePause = (delegate* unmanaged<uint, void>)QGL.GetALProcAddress("alSourcePause");
        _alSourcePlayv = (delegate* unmanaged<int, uint*, void>)QGL.GetALProcAddress("alSourcePlayv");
        _alSourceStopv = (delegate* unmanaged<int, uint*, void>)QGL.GetALProcAddress("alSourceStopv");
        _alSourceRewindv = (delegate* unmanaged<int, uint*, void>)QGL.GetALProcAddress("alSourceRewindv");
        _alSourcePausev = (delegate* unmanaged<int, uint*, void>)QGL.GetALProcAddress("alSourcePausev");
        _alSourceQueueBuffers = (delegate* unmanaged<uint, int, uint*, void>)QGL.GetALProcAddress("alSourceQueueBuffers");
        _alSourceUnqueueBuffers = (delegate* unmanaged<uint, int, uint*, void>)QGL.GetALProcAddress("alSourceUnqueueBuffers");
        _alGenBuffers = (delegate* unmanaged<int, uint*, void>)QGL.GetALProcAddress("alGenBuffers");
        _alDeleteBuffers = (delegate* unmanaged<int, uint*, void>)QGL.GetALProcAddress("alDeleteBuffers");
        _alIsBuffer = (delegate* unmanaged<uint, bool>)QGL.GetALProcAddress("alIsBuffer");
        _alBufferData = (delegate* unmanaged<uint, int, void*, int, int, void>)QGL.GetALProcAddress("alBufferData");
        _alBufferf = (delegate* unmanaged<uint, int, float, void>)QGL.GetALProcAddress("alBufferf");
        _alBuffer3f = (delegate* unmanaged<uint, int, float, float, float, void>)QGL.GetALProcAddress("alBuffer3f");
        _alBufferfv = (delegate* unmanaged<uint, int, float*, void>)QGL.GetALProcAddress("alBufferfv");
        _alBufferi = (delegate* unmanaged<uint, int, int, void>)QGL.GetALProcAddress("alBufferi");
        _alBuffer3i = (delegate* unmanaged<uint, int, int, int, int, void>)QGL.GetALProcAddress("alBuffer3i");
        _alBufferiv = (delegate* unmanaged<uint, int, int*, void>)QGL.GetALProcAddress("alBufferiv");
        _alGetBufferf = (delegate* unmanaged<uint, int, float*, void>)QGL.GetALProcAddress("alGetBufferf");
        _alGetBuffer3f = (delegate* unmanaged<uint, int, float*, float*, float*, void>)QGL.GetALProcAddress("alGetBuffer3f");
        _alGetBufferfv = (delegate* unmanaged<uint, int, float*, void>)QGL.GetALProcAddress("alGetBufferfv");
        _alGetBufferi = (delegate* unmanaged<uint, int, int*, void>)QGL.GetALProcAddress("alGetBufferi");
        _alGetBuffer3i = (delegate* unmanaged<uint, int, int*, int*, int*, void>)QGL.GetALProcAddress("alGetBuffer3i");
        _alGetBufferiv = (delegate* unmanaged<uint, int, int*, void>)QGL.GetALProcAddress("alGetBufferiv");
        _alSpeedOfSound = (delegate* unmanaged<float, void>)QGL.GetALProcAddress("alSpeedOfSound");
    }
    ...
    public static bool alGetBoolean(int param) { QGLFeature.VerifyFunc((nint)_alGetBoolean); return _alGetBoolean(param); }
    ...
    public static bool alIsExtensionPresent(byte* extname) { QGLFeature.VerifyFunc((nint)_alIsExtensionPresent); return _alIsExtensionPresent(extname); }
    ...
    public static bool alIsSource(uint source) { QGLFeature.VerifyFunc((nint)_alIsSource); return _alIsSource(source); }
    ...
    public static bool alIsBuffer(uint buffer) { QGLFeature.VerifyFunc((nint)_alIsBuffer); return _alIsBuffer(buffer); }
