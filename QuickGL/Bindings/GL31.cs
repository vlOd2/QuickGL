...
public static unsafe class GL31
{
    ...
    internal static void Load()
    {
        ...
        _glPrimitiveRestartIndex = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glPrimitiveRestartIndex");
        ...
        _glGetActiveUniformName = (delegate* unmanaged<uint, uint, int, int*, byte*, void>)QGL.GetGLProcAddress("glGetActiveUniformName");
