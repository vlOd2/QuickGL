...
public static unsafe class GL13
{
    ...
    internal static void Load()
    {
        ...
        _glCompressedTexImage1D = (delegate* unmanaged<uint, int, uint, int, int, int, void*, void>)QGL.GetGLProcAddress("glCompressedTexImage1D");
        ...
        _glCompressedTexSubImage1D = (delegate* unmanaged<uint, int, int, int, uint, int, void*, void>)QGL.GetGLProcAddress("glCompressedTexSubImage1D");
        _glGetCompressedTexImage = (delegate* unmanaged<uint, int, void*, void>)QGL.GetGLProcAddress("glGetCompressedTexImage");
        _glClientActiveTexture = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glClientActiveTexture");
        _glMultiTexCoord1d = (delegate* unmanaged<uint, double, void>)QGL.GetGLProcAddress("glMultiTexCoord1d");
        _glMultiTexCoord1dv = (delegate* unmanaged<uint, double*, void>)QGL.GetGLProcAddress("glMultiTexCoord1dv");
        _glMultiTexCoord1f = (delegate* unmanaged<uint, float, void>)QGL.GetGLProcAddress("glMultiTexCoord1f");
        _glMultiTexCoord1fv = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glMultiTexCoord1fv");
        _glMultiTexCoord1i = (delegate* unmanaged<uint, int, void>)QGL.GetGLProcAddress("glMultiTexCoord1i");
        _glMultiTexCoord1iv = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glMultiTexCoord1iv");
        _glMultiTexCoord1s = (delegate* unmanaged<uint, short, void>)QGL.GetGLProcAddress("glMultiTexCoord1s");
        _glMultiTexCoord1sv = (delegate* unmanaged<uint, short*, void>)QGL.GetGLProcAddress("glMultiTexCoord1sv");
        _glMultiTexCoord2d = (delegate* unmanaged<uint, double, double, void>)QGL.GetGLProcAddress("glMultiTexCoord2d");
        _glMultiTexCoord2dv = (delegate* unmanaged<uint, double*, void>)QGL.GetGLProcAddress("glMultiTexCoord2dv");
        _glMultiTexCoord2f = (delegate* unmanaged<uint, float, float, void>)QGL.GetGLProcAddress("glMultiTexCoord2f");
        _glMultiTexCoord2fv = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glMultiTexCoord2fv");
        _glMultiTexCoord2i = (delegate* unmanaged<uint, int, int, void>)QGL.GetGLProcAddress("glMultiTexCoord2i");
        _glMultiTexCoord2iv = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glMultiTexCoord2iv");
        _glMultiTexCoord2s = (delegate* unmanaged<uint, short, short, void>)QGL.GetGLProcAddress("glMultiTexCoord2s");
        _glMultiTexCoord2sv = (delegate* unmanaged<uint, short*, void>)QGL.GetGLProcAddress("glMultiTexCoord2sv");
        _glMultiTexCoord3d = (delegate* unmanaged<uint, double, double, double, void>)QGL.GetGLProcAddress("glMultiTexCoord3d");
        _glMultiTexCoord3dv = (delegate* unmanaged<uint, double*, void>)QGL.GetGLProcAddress("glMultiTexCoord3dv");
        _glMultiTexCoord3f = (delegate* unmanaged<uint, float, float, float, void>)QGL.GetGLProcAddress("glMultiTexCoord3f");
        _glMultiTexCoord3fv = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glMultiTexCoord3fv");
        _glMultiTexCoord3i = (delegate* unmanaged<uint, int, int, int, void>)QGL.GetGLProcAddress("glMultiTexCoord3i");
        _glMultiTexCoord3iv = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glMultiTexCoord3iv");
        _glMultiTexCoord3s = (delegate* unmanaged<uint, short, short, short, void>)QGL.GetGLProcAddress("glMultiTexCoord3s");
        _glMultiTexCoord3sv = (delegate* unmanaged<uint, short*, void>)QGL.GetGLProcAddress("glMultiTexCoord3sv");
        _glMultiTexCoord4d = (delegate* unmanaged<uint, double, double, double, double, void>)QGL.GetGLProcAddress("glMultiTexCoord4d");
        _glMultiTexCoord4dv = (delegate* unmanaged<uint, double*, void>)QGL.GetGLProcAddress("glMultiTexCoord4dv");
        _glMultiTexCoord4f = (delegate* unmanaged<uint, float, float, float, float, void>)QGL.GetGLProcAddress("glMultiTexCoord4f");
        _glMultiTexCoord4fv = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glMultiTexCoord4fv");
        _glMultiTexCoord4i = (delegate* unmanaged<uint, int, int, int, int, void>)QGL.GetGLProcAddress("glMultiTexCoord4i");
        _glMultiTexCoord4iv = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glMultiTexCoord4iv");
        _glMultiTexCoord4s = (delegate* unmanaged<uint, short, short, short, short, void>)QGL.GetGLProcAddress("glMultiTexCoord4s");
        _glMultiTexCoord4sv = (delegate* unmanaged<uint, short*, void>)QGL.GetGLProcAddress("glMultiTexCoord4sv");
        _glLoadTransposeMatrixf = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glLoadTransposeMatrixf");
        _glLoadTransposeMatrixd = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glLoadTransposeMatrixd");
        _glMultTransposeMatrixf = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glMultTransposeMatrixf");
        _glMultTransposeMatrixd = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glMultTransposeMatrixd");
    }
