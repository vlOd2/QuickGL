...
public static unsafe class GLES20
{
    ...
    {
        _glActiveTexture = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glActiveTexture");
        _glAttachShader = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glAttachShader");
        _glBindAttribLocation = (delegate* unmanaged<uint, uint, byte*, void>)QGL.GetGLProcAddress("glBindAttribLocation");
        ...
        _glBindTexture = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glBindTexture");
        ...
        _glBlendEquationSeparate = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glBlendEquationSeparate");
        ...
        _glCompileShader = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glCompileShader");
        _glCompressedTexImage2D = (delegate* unmanaged<uint, int, uint, int, int, int, int, void*, void>)QGL.GetGLProcAddress("glCompressedTexImage2D");
        _glCompressedTexSubImage2D = (delegate* unmanaged<uint, int, int, int, int, int, uint, int, void*, void>)QGL.GetGLProcAddress("glCompressedTexSubImage2D");
        _glCopyTexImage2D = (delegate* unmanaged<uint, int, uint, int, int, int, int, int, void>)QGL.GetGLProcAddress("glCopyTexImage2D");
        _glCopyTexSubImage2D = (delegate* unmanaged<uint, int, int, int, int, int, int, int, void>)QGL.GetGLProcAddress("glCopyTexSubImage2D");
        _glCreateProgram = (delegate* unmanaged<uint>)QGL.GetGLProcAddress("glCreateProgram");
        _glCreateShader = (delegate* unmanaged<uint, uint>)QGL.GetGLProcAddress("glCreateShader");
        ...
        _glDeleteProgram = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glDeleteProgram");
        _glDeleteRenderbuffers = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glDeleteRenderbuffers");
        _glDeleteShader = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glDeleteShader");
        _glDeleteTextures = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glDeleteTextures");
        ...
        _glDetachShader = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glDetachShader");
        _glDisable = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glDisable");
        _glDisableVertexAttribArray = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glDisableVertexAttribArray");
        _glDrawArrays = (delegate* unmanaged<uint, int, int, void>)QGL.GetGLProcAddress("glDrawArrays");
        _glDrawElements = (delegate* unmanaged<uint, int, uint, void*, void>)QGL.GetGLProcAddress("glDrawElements");
        _glEnable = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glEnable");
        _glEnableVertexAttribArray = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glEnableVertexAttribArray");
        ...
        _glGenTextures = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glGenTextures");
        _glGetActiveAttrib = (delegate* unmanaged<uint, uint, int, int*, int*, uint*, byte*, void>)QGL.GetGLProcAddress("glGetActiveAttrib");
        _glGetActiveUniform = (delegate* unmanaged<uint, uint, int, int*, int*, uint*, byte*, void>)QGL.GetGLProcAddress("glGetActiveUniform");
        _glGetAttachedShaders = (delegate* unmanaged<uint, int, int*, uint*, void>)QGL.GetGLProcAddress("glGetAttachedShaders");
        _glGetAttribLocation = (delegate* unmanaged<uint, byte*, int>)QGL.GetGLProcAddress("glGetAttribLocation");
        ...
        _glGetProgramiv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetProgramiv");
        _glGetProgramInfoLog = (delegate* unmanaged<uint, int, int*, byte*, void>)QGL.GetGLProcAddress("glGetProgramInfoLog");
        _glGetRenderbufferParameteriv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetRenderbufferParameteriv");
        _glGetShaderiv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetShaderiv");
        _glGetShaderInfoLog = (delegate* unmanaged<uint, int, int*, byte*, void>)QGL.GetGLProcAddress("glGetShaderInfoLog");
        _glGetShaderPrecisionFormat = (delegate* unmanaged<uint, uint, int*, int*, void>)QGL.GetGLProcAddress("glGetShaderPrecisionFormat");
        _glGetShaderSource = (delegate* unmanaged<uint, int, int*, byte*, void>)QGL.GetGLProcAddress("glGetShaderSource");
        ...
        _glGetUniformfv = (delegate* unmanaged<uint, int, float*, void>)QGL.GetGLProcAddress("glGetUniformfv");
        _glGetUniformiv = (delegate* unmanaged<uint, int, int*, void>)QGL.GetGLProcAddress("glGetUniformiv");
        _glGetUniformLocation = (delegate* unmanaged<uint, byte*, int>)QGL.GetGLProcAddress("glGetUniformLocation");
        _glGetVertexAttribfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetVertexAttribfv");
        _glGetVertexAttribiv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetVertexAttribiv");
        _glGetVertexAttribPointerv = (delegate* unmanaged<uint, uint, void**, void>)QGL.GetGLProcAddress("glGetVertexAttribPointerv");
        ...
        _glIsProgram = (delegate* unmanaged<uint, bool>)QGL.GetGLProcAddress("glIsProgram");
        _glIsRenderbuffer = (delegate* unmanaged<uint, bool>)QGL.GetGLProcAddress("glIsRenderbuffer");
        _glIsShader = (delegate* unmanaged<uint, bool>)QGL.GetGLProcAddress("glIsShader");
        _glIsTexture = (delegate* unmanaged<uint, bool>)QGL.GetGLProcAddress("glIsTexture");
        _glLineWidth = (delegate* unmanaged<float, void>)QGL.GetGLProcAddress("glLineWidth");
        _glLinkProgram = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glLinkProgram");
        _glPixelStorei = (delegate* unmanaged<uint, int, void>)QGL.GetGLProcAddress("glPixelStorei");
        _glPolygonOffset = (delegate* unmanaged<float, float, void>)QGL.GetGLProcAddress("glPolygonOffset");
        ...
        _glSampleCoverage = (delegate* unmanaged<float, bool, void>)QGL.GetGLProcAddress("glSampleCoverage");
        ...
        _glShaderSource = (delegate* unmanaged<uint, int, byte**, int*, void>)QGL.GetGLProcAddress("glShaderSource");
        _glStencilFunc = (delegate* unmanaged<uint, int, uint, void>)QGL.GetGLProcAddress("glStencilFunc");
        _glStencilFuncSeparate = (delegate* unmanaged<uint, uint, int, uint, void>)QGL.GetGLProcAddress("glStencilFuncSeparate");
        _glStencilMask = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glStencilMask");
        _glStencilMaskSeparate = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glStencilMaskSeparate");
        _glStencilOp = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glStencilOp");
        _glStencilOpSeparate = (delegate* unmanaged<uint, uint, uint, uint, void>)QGL.GetGLProcAddress("glStencilOpSeparate");
        ...
        _glTexSubImage2D = (delegate* unmanaged<uint, int, int, int, int, int, uint, uint, void*, void>)QGL.GetGLProcAddress("glTexSubImage2D");
        _glUniform1f = (delegate* unmanaged<int, float, void>)QGL.GetGLProcAddress("glUniform1f");
        _glUniform1fv = (delegate* unmanaged<int, int, float*, void>)QGL.GetGLProcAddress("glUniform1fv");
        _glUniform1i = (delegate* unmanaged<int, int, void>)QGL.GetGLProcAddress("glUniform1i");
        _glUniform1iv = (delegate* unmanaged<int, int, int*, void>)QGL.GetGLProcAddress("glUniform1iv");
        _glUniform2f = (delegate* unmanaged<int, float, float, void>)QGL.GetGLProcAddress("glUniform2f");
        _glUniform2fv = (delegate* unmanaged<int, int, float*, void>)QGL.GetGLProcAddress("glUniform2fv");
        _glUniform2i = (delegate* unmanaged<int, int, int, void>)QGL.GetGLProcAddress("glUniform2i");
        _glUniform2iv = (delegate* unmanaged<int, int, int*, void>)QGL.GetGLProcAddress("glUniform2iv");
        _glUniform3f = (delegate* unmanaged<int, float, float, float, void>)QGL.GetGLProcAddress("glUniform3f");
        _glUniform3fv = (delegate* unmanaged<int, int, float*, void>)QGL.GetGLProcAddress("glUniform3fv");
        _glUniform3i = (delegate* unmanaged<int, int, int, int, void>)QGL.GetGLProcAddress("glUniform3i");
        _glUniform3iv = (delegate* unmanaged<int, int, int*, void>)QGL.GetGLProcAddress("glUniform3iv");
        _glUniform4f = (delegate* unmanaged<int, float, float, float, float, void>)QGL.GetGLProcAddress("glUniform4f");
        _glUniform4fv = (delegate* unmanaged<int, int, float*, void>)QGL.GetGLProcAddress("glUniform4fv");
        _glUniform4i = (delegate* unmanaged<int, int, int, int, int, void>)QGL.GetGLProcAddress("glUniform4i");
        _glUniform4iv = (delegate* unmanaged<int, int, int*, void>)QGL.GetGLProcAddress("glUniform4iv");
        _glUniformMatrix2fv = (delegate* unmanaged<int, int, bool, float*, void>)QGL.GetGLProcAddress("glUniformMatrix2fv");
        _glUniformMatrix3fv = (delegate* unmanaged<int, int, bool, float*, void>)QGL.GetGLProcAddress("glUniformMatrix3fv");
        _glUniformMatrix4fv = (delegate* unmanaged<int, int, bool, float*, void>)QGL.GetGLProcAddress("glUniformMatrix4fv");
        _glUseProgram = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glUseProgram");
        _glValidateProgram = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glValidateProgram");
        _glVertexAttrib1f = (delegate* unmanaged<uint, float, void>)QGL.GetGLProcAddress("glVertexAttrib1f");
        _glVertexAttrib1fv = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glVertexAttrib1fv");
        _glVertexAttrib2f = (delegate* unmanaged<uint, float, float, void>)QGL.GetGLProcAddress("glVertexAttrib2f");
        _glVertexAttrib2fv = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glVertexAttrib2fv");
        _glVertexAttrib3f = (delegate* unmanaged<uint, float, float, float, void>)QGL.GetGLProcAddress("glVertexAttrib3f");
        _glVertexAttrib3fv = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glVertexAttrib3fv");
        _glVertexAttrib4f = (delegate* unmanaged<uint, float, float, float, float, void>)QGL.GetGLProcAddress("glVertexAttrib4f");
        _glVertexAttrib4fv = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glVertexAttrib4fv");
        _glVertexAttribPointer = (delegate* unmanaged<uint, int, uint, bool, int, void*, void>)QGL.GetGLProcAddress("glVertexAttribPointer");
