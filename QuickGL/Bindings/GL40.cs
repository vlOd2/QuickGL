...
public static unsafe class GL40
{
    ...
    {
        _glMinSampleShading = (delegate* unmanaged<float, void>)QGL.GetGLProcAddress("glMinSampleShading");
        _glBlendEquationi = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glBlendEquationi");
        _glBlendEquationSeparatei = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glBlendEquationSeparatei");
        _glBlendFunci = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glBlendFunci");
        _glBlendFuncSeparatei = (delegate* unmanaged<uint, uint, uint, uint, uint, void>)QGL.GetGLProcAddress("glBlendFuncSeparatei");
        ...
        _glUniform1d = (delegate* unmanaged<int, double, void>)QGL.GetGLProcAddress("glUniform1d");
        _glUniform2d = (delegate* unmanaged<int, double, double, void>)QGL.GetGLProcAddress("glUniform2d");
        _glUniform3d = (delegate* unmanaged<int, double, double, double, void>)QGL.GetGLProcAddress("glUniform3d");
        _glUniform4d = (delegate* unmanaged<int, double, double, double, double, void>)QGL.GetGLProcAddress("glUniform4d");
        _glUniform1dv = (delegate* unmanaged<int, int, double*, void>)QGL.GetGLProcAddress("glUniform1dv");
        _glUniform2dv = (delegate* unmanaged<int, int, double*, void>)QGL.GetGLProcAddress("glUniform2dv");
        _glUniform3dv = (delegate* unmanaged<int, int, double*, void>)QGL.GetGLProcAddress("glUniform3dv");
        _glUniform4dv = (delegate* unmanaged<int, int, double*, void>)QGL.GetGLProcAddress("glUniform4dv");
        _glUniformMatrix2dv = (delegate* unmanaged<int, int, bool, double*, void>)QGL.GetGLProcAddress("glUniformMatrix2dv");
        _glUniformMatrix3dv = (delegate* unmanaged<int, int, bool, double*, void>)QGL.GetGLProcAddress("glUniformMatrix3dv");
        _glUniformMatrix4dv = (delegate* unmanaged<int, int, bool, double*, void>)QGL.GetGLProcAddress("glUniformMatrix4dv");
        _glUniformMatrix2x3dv = (delegate* unmanaged<int, int, bool, double*, void>)QGL.GetGLProcAddress("glUniformMatrix2x3dv");
        _glUniformMatrix2x4dv = (delegate* unmanaged<int, int, bool, double*, void>)QGL.GetGLProcAddress("glUniformMatrix2x4dv");
        _glUniformMatrix3x2dv = (delegate* unmanaged<int, int, bool, double*, void>)QGL.GetGLProcAddress("glUniformMatrix3x2dv");
        _glUniformMatrix3x4dv = (delegate* unmanaged<int, int, bool, double*, void>)QGL.GetGLProcAddress("glUniformMatrix3x4dv");
        _glUniformMatrix4x2dv = (delegate* unmanaged<int, int, bool, double*, void>)QGL.GetGLProcAddress("glUniformMatrix4x2dv");
        _glUniformMatrix4x3dv = (delegate* unmanaged<int, int, bool, double*, void>)QGL.GetGLProcAddress("glUniformMatrix4x3dv");
        _glGetUniformdv = (delegate* unmanaged<uint, int, double*, void>)QGL.GetGLProcAddress("glGetUniformdv");
        _glGetSubroutineUniformLocation = (delegate* unmanaged<uint, uint, byte*, int>)QGL.GetGLProcAddress("glGetSubroutineUniformLocation");
        _glGetSubroutineIndex = (delegate* unmanaged<uint, uint, byte*, uint>)QGL.GetGLProcAddress("glGetSubroutineIndex");
        _glGetActiveSubroutineUniformiv = (delegate* unmanaged<uint, uint, uint, uint, int*, void>)QGL.GetGLProcAddress("glGetActiveSubroutineUniformiv");
        _glGetActiveSubroutineUniformName = (delegate* unmanaged<uint, uint, uint, int, int*, byte*, void>)QGL.GetGLProcAddress("glGetActiveSubroutineUniformName");
        _glGetActiveSubroutineName = (delegate* unmanaged<uint, uint, uint, int, int*, byte*, void>)QGL.GetGLProcAddress("glGetActiveSubroutineName");
        _glUniformSubroutinesuiv = (delegate* unmanaged<uint, int, uint*, void>)QGL.GetGLProcAddress("glUniformSubroutinesuiv");
        _glGetUniformSubroutineuiv = (delegate* unmanaged<uint, int, uint*, void>)QGL.GetGLProcAddress("glGetUniformSubroutineuiv");
        _glGetProgramStageiv = (delegate* unmanaged<uint, uint, uint, int*, void>)QGL.GetGLProcAddress("glGetProgramStageiv");
        _glPatchParameteri = (delegate* unmanaged<uint, int, void>)QGL.GetGLProcAddress("glPatchParameteri");
        _glPatchParameterfv = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glPatchParameterfv");
