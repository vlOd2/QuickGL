...
public static unsafe class GL10
{
    ...
    {
        _glCullFace = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glCullFace");
        _glFrontFace = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glFrontFace");
        _glHint = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glHint");
        _glLineWidth = (delegate* unmanaged<float, void>)QGL.GetGLProcAddress("glLineWidth");
        _glPointSize = (delegate* unmanaged<float, void>)QGL.GetGLProcAddress("glPointSize");
        _glPolygonMode = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glPolygonMode");
        _glScissor = (delegate* unmanaged<int, int, int, int, void>)QGL.GetGLProcAddress("glScissor");
        _glTexParameterf = (delegate* unmanaged<uint, uint, float, void>)QGL.GetGLProcAddress("glTexParameterf");
        _glTexParameterfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glTexParameterfv");
        _glTexParameteri = (delegate* unmanaged<uint, uint, int, void>)QGL.GetGLProcAddress("glTexParameteri");
        _glTexParameteriv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glTexParameteriv");
        _glTexImage1D = (delegate* unmanaged<uint, int, int, int, int, uint, uint, void*, void>)QGL.GetGLProcAddress("glTexImage1D");
        _glTexImage2D = (delegate* unmanaged<uint, int, int, int, int, int, uint, uint, void*, void>)QGL.GetGLProcAddress("glTexImage2D");
        _glDrawBuffer = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glDrawBuffer");
        _glClear = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glClear");
        _glClearColor = (delegate* unmanaged<float, float, float, float, void>)QGL.GetGLProcAddress("glClearColor");
        _glClearStencil = (delegate* unmanaged<int, void>)QGL.GetGLProcAddress("glClearStencil");
        _glClearDepth = (delegate* unmanaged<double, void>)QGL.GetGLProcAddress("glClearDepth");
        _glStencilMask = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glStencilMask");
        _glColorMask = (delegate* unmanaged<bool, bool, bool, bool, void>)QGL.GetGLProcAddress("glColorMask");
        _glDepthMask = (delegate* unmanaged<bool, void>)QGL.GetGLProcAddress("glDepthMask");
        _glDisable = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glDisable");
        _glEnable = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glEnable");
        _glFinish = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glFinish");
        _glFlush = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glFlush");
        _glBlendFunc = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glBlendFunc");
        _glLogicOp = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glLogicOp");
        _glStencilFunc = (delegate* unmanaged<uint, int, uint, void>)QGL.GetGLProcAddress("glStencilFunc");
        _glStencilOp = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glStencilOp");
        _glDepthFunc = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glDepthFunc");
        _glPixelStoref = (delegate* unmanaged<uint, float, void>)QGL.GetGLProcAddress("glPixelStoref");
        _glPixelStorei = (delegate* unmanaged<uint, int, void>)QGL.GetGLProcAddress("glPixelStorei");
        _glReadBuffer = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glReadBuffer");
        _glReadPixels = (delegate* unmanaged<int, int, int, int, uint, uint, void*, void>)QGL.GetGLProcAddress("glReadPixels");
        _glGetBooleanv = (delegate* unmanaged<uint, bool*, void>)QGL.GetGLProcAddress("glGetBooleanv");
        _glGetDoublev = (delegate* unmanaged<uint, double*, void>)QGL.GetGLProcAddress("glGetDoublev");
        _glGetError = (delegate* unmanaged<uint>)QGL.GetGLProcAddress("glGetError");
        _glGetFloatv = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glGetFloatv");
        _glGetIntegerv = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glGetIntegerv");
        _glGetString = (delegate* unmanaged<uint, byte*>)QGL.GetGLProcAddress("glGetString");
        _glGetTexImage = (delegate* unmanaged<uint, int, uint, uint, void*, void>)QGL.GetGLProcAddress("glGetTexImage");
        _glGetTexParameterfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetTexParameterfv");
        _glGetTexParameteriv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetTexParameteriv");
        _glGetTexLevelParameterfv = (delegate* unmanaged<uint, int, uint, float*, void>)QGL.GetGLProcAddress("glGetTexLevelParameterfv");
        _glGetTexLevelParameteriv = (delegate* unmanaged<uint, int, uint, int*, void>)QGL.GetGLProcAddress("glGetTexLevelParameteriv");
        _glIsEnabled = (delegate* unmanaged<uint, bool>)QGL.GetGLProcAddress("glIsEnabled");
        _glDepthRange = (delegate* unmanaged<double, double, void>)QGL.GetGLProcAddress("glDepthRange");
        _glViewport = (delegate* unmanaged<int, int, int, int, void>)QGL.GetGLProcAddress("glViewport");
        _glNewList = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glNewList");
        _glEndList = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glEndList");
        _glCallList = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glCallList");
        _glCallLists = (delegate* unmanaged<int, uint, void*, void>)QGL.GetGLProcAddress("glCallLists");
        _glDeleteLists = (delegate* unmanaged<uint, int, void>)QGL.GetGLProcAddress("glDeleteLists");
        _glGenLists = (delegate* unmanaged<int, uint>)QGL.GetGLProcAddress("glGenLists");
        _glListBase = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glListBase");
        _glBegin = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glBegin");
        _glBitmap = (delegate* unmanaged<int, int, float, float, float, float, byte*, void>)QGL.GetGLProcAddress("glBitmap");
        _glColor3b = (delegate* unmanaged<sbyte, sbyte, sbyte, void>)QGL.GetGLProcAddress("glColor3b");
        _glColor3bv = (delegate* unmanaged<sbyte*, void>)QGL.GetGLProcAddress("glColor3bv");
        _glColor3d = (delegate* unmanaged<double, double, double, void>)QGL.GetGLProcAddress("glColor3d");
        _glColor3dv = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glColor3dv");
        _glColor3f = (delegate* unmanaged<float, float, float, void>)QGL.GetGLProcAddress("glColor3f");
        _glColor3fv = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glColor3fv");
        _glColor3i = (delegate* unmanaged<int, int, int, void>)QGL.GetGLProcAddress("glColor3i");
        _glColor3iv = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glColor3iv");
        _glColor3s = (delegate* unmanaged<short, short, short, void>)QGL.GetGLProcAddress("glColor3s");
        _glColor3sv = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glColor3sv");
        _glColor3ub = (delegate* unmanaged<byte, byte, byte, void>)QGL.GetGLProcAddress("glColor3ub");
        _glColor3ubv = (delegate* unmanaged<byte*, void>)QGL.GetGLProcAddress("glColor3ubv");
        _glColor3ui = (delegate* unmanaged<uint, uint, uint, void>)QGL.GetGLProcAddress("glColor3ui");
        _glColor3uiv = (delegate* unmanaged<uint*, void>)QGL.GetGLProcAddress("glColor3uiv");
        _glColor3us = (delegate* unmanaged<ushort, ushort, ushort, void>)QGL.GetGLProcAddress("glColor3us");
        _glColor3usv = (delegate* unmanaged<ushort*, void>)QGL.GetGLProcAddress("glColor3usv");
        _glColor4b = (delegate* unmanaged<sbyte, sbyte, sbyte, sbyte, void>)QGL.GetGLProcAddress("glColor4b");
        _glColor4bv = (delegate* unmanaged<sbyte*, void>)QGL.GetGLProcAddress("glColor4bv");
        _glColor4d = (delegate* unmanaged<double, double, double, double, void>)QGL.GetGLProcAddress("glColor4d");
        _glColor4dv = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glColor4dv");
        _glColor4f = (delegate* unmanaged<float, float, float, float, void>)QGL.GetGLProcAddress("glColor4f");
        _glColor4fv = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glColor4fv");
        _glColor4i = (delegate* unmanaged<int, int, int, int, void>)QGL.GetGLProcAddress("glColor4i");
        _glColor4iv = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glColor4iv");
        _glColor4s = (delegate* unmanaged<short, short, short, short, void>)QGL.GetGLProcAddress("glColor4s");
        _glColor4sv = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glColor4sv");
        _glColor4ub = (delegate* unmanaged<byte, byte, byte, byte, void>)QGL.GetGLProcAddress("glColor4ub");
        _glColor4ubv = (delegate* unmanaged<byte*, void>)QGL.GetGLProcAddress("glColor4ubv");
        _glColor4ui = (delegate* unmanaged<uint, uint, uint, uint, void>)QGL.GetGLProcAddress("glColor4ui");
        _glColor4uiv = (delegate* unmanaged<uint*, void>)QGL.GetGLProcAddress("glColor4uiv");
        _glColor4us = (delegate* unmanaged<ushort, ushort, ushort, ushort, void>)QGL.GetGLProcAddress("glColor4us");
        _glColor4usv = (delegate* unmanaged<ushort*, void>)QGL.GetGLProcAddress("glColor4usv");
        _glEdgeFlag = (delegate* unmanaged<bool, void>)QGL.GetGLProcAddress("glEdgeFlag");
        _glEdgeFlagv = (delegate* unmanaged<bool*, void>)QGL.GetGLProcAddress("glEdgeFlagv");
        _glEnd = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glEnd");
        _glIndexd = (delegate* unmanaged<double, void>)QGL.GetGLProcAddress("glIndexd");
        _glIndexdv = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glIndexdv");
        _glIndexf = (delegate* unmanaged<float, void>)QGL.GetGLProcAddress("glIndexf");
        _glIndexfv = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glIndexfv");
        _glIndexi = (delegate* unmanaged<int, void>)QGL.GetGLProcAddress("glIndexi");
        _glIndexiv = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glIndexiv");
        _glIndexs = (delegate* unmanaged<short, void>)QGL.GetGLProcAddress("glIndexs");
        _glIndexsv = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glIndexsv");
        _glNormal3b = (delegate* unmanaged<sbyte, sbyte, sbyte, void>)QGL.GetGLProcAddress("glNormal3b");
        _glNormal3bv = (delegate* unmanaged<sbyte*, void>)QGL.GetGLProcAddress("glNormal3bv");
        _glNormal3d = (delegate* unmanaged<double, double, double, void>)QGL.GetGLProcAddress("glNormal3d");
        _glNormal3dv = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glNormal3dv");
        _glNormal3f = (delegate* unmanaged<float, float, float, void>)QGL.GetGLProcAddress("glNormal3f");
        _glNormal3fv = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glNormal3fv");
        _glNormal3i = (delegate* unmanaged<int, int, int, void>)QGL.GetGLProcAddress("glNormal3i");
        _glNormal3iv = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glNormal3iv");
        _glNormal3s = (delegate* unmanaged<short, short, short, void>)QGL.GetGLProcAddress("glNormal3s");
        _glNormal3sv = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glNormal3sv");
        _glRasterPos2d = (delegate* unmanaged<double, double, void>)QGL.GetGLProcAddress("glRasterPos2d");
        _glRasterPos2dv = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glRasterPos2dv");
        _glRasterPos2f = (delegate* unmanaged<float, float, void>)QGL.GetGLProcAddress("glRasterPos2f");
        _glRasterPos2fv = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glRasterPos2fv");
        _glRasterPos2i = (delegate* unmanaged<int, int, void>)QGL.GetGLProcAddress("glRasterPos2i");
        _glRasterPos2iv = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glRasterPos2iv");
        _glRasterPos2s = (delegate* unmanaged<short, short, void>)QGL.GetGLProcAddress("glRasterPos2s");
        _glRasterPos2sv = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glRasterPos2sv");
        _glRasterPos3d = (delegate* unmanaged<double, double, double, void>)QGL.GetGLProcAddress("glRasterPos3d");
        _glRasterPos3dv = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glRasterPos3dv");
        _glRasterPos3f = (delegate* unmanaged<float, float, float, void>)QGL.GetGLProcAddress("glRasterPos3f");
        _glRasterPos3fv = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glRasterPos3fv");
        _glRasterPos3i = (delegate* unmanaged<int, int, int, void>)QGL.GetGLProcAddress("glRasterPos3i");
        _glRasterPos3iv = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glRasterPos3iv");
        _glRasterPos3s = (delegate* unmanaged<short, short, short, void>)QGL.GetGLProcAddress("glRasterPos3s");
        _glRasterPos3sv = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glRasterPos3sv");
        _glRasterPos4d = (delegate* unmanaged<double, double, double, double, void>)QGL.GetGLProcAddress("glRasterPos4d");
        _glRasterPos4dv = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glRasterPos4dv");
        _glRasterPos4f = (delegate* unmanaged<float, float, float, float, void>)QGL.GetGLProcAddress("glRasterPos4f");
        _glRasterPos4fv = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glRasterPos4fv");
        _glRasterPos4i = (delegate* unmanaged<int, int, int, int, void>)QGL.GetGLProcAddress("glRasterPos4i");
        _glRasterPos4iv = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glRasterPos4iv");
        _glRasterPos4s = (delegate* unmanaged<short, short, short, short, void>)QGL.GetGLProcAddress("glRasterPos4s");
        _glRasterPos4sv = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glRasterPos4sv");
        _glRectd = (delegate* unmanaged<double, double, double, double, void>)QGL.GetGLProcAddress("glRectd");
        _glRectdv = (delegate* unmanaged<double*, double*, void>)QGL.GetGLProcAddress("glRectdv");
        _glRectf = (delegate* unmanaged<float, float, float, float, void>)QGL.GetGLProcAddress("glRectf");
        _glRectfv = (delegate* unmanaged<float*, float*, void>)QGL.GetGLProcAddress("glRectfv");
        _glRecti = (delegate* unmanaged<int, int, int, int, void>)QGL.GetGLProcAddress("glRecti");
        _glRectiv = (delegate* unmanaged<int*, int*, void>)QGL.GetGLProcAddress("glRectiv");
        _glRects = (delegate* unmanaged<short, short, short, short, void>)QGL.GetGLProcAddress("glRects");
        _glRectsv = (delegate* unmanaged<short*, short*, void>)QGL.GetGLProcAddress("glRectsv");
        _glTexCoord1d = (delegate* unmanaged<double, void>)QGL.GetGLProcAddress("glTexCoord1d");
        _glTexCoord1dv = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glTexCoord1dv");
        _glTexCoord1f = (delegate* unmanaged<float, void>)QGL.GetGLProcAddress("glTexCoord1f");
        _glTexCoord1fv = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glTexCoord1fv");
        _glTexCoord1i = (delegate* unmanaged<int, void>)QGL.GetGLProcAddress("glTexCoord1i");
        _glTexCoord1iv = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glTexCoord1iv");
        _glTexCoord1s = (delegate* unmanaged<short, void>)QGL.GetGLProcAddress("glTexCoord1s");
        _glTexCoord1sv = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glTexCoord1sv");
        _glTexCoord2d = (delegate* unmanaged<double, double, void>)QGL.GetGLProcAddress("glTexCoord2d");
        _glTexCoord2dv = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glTexCoord2dv");
        _glTexCoord2f = (delegate* unmanaged<float, float, void>)QGL.GetGLProcAddress("glTexCoord2f");
        _glTexCoord2fv = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glTexCoord2fv");
        _glTexCoord2i = (delegate* unmanaged<int, int, void>)QGL.GetGLProcAddress("glTexCoord2i");
        _glTexCoord2iv = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glTexCoord2iv");
        _glTexCoord2s = (delegate* unmanaged<short, short, void>)QGL.GetGLProcAddress("glTexCoord2s");
        _glTexCoord2sv = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glTexCoord2sv");
        _glTexCoord3d = (delegate* unmanaged<double, double, double, void>)QGL.GetGLProcAddress("glTexCoord3d");
        _glTexCoord3dv = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glTexCoord3dv");
        _glTexCoord3f = (delegate* unmanaged<float, float, float, void>)QGL.GetGLProcAddress("glTexCoord3f");
        _glTexCoord3fv = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glTexCoord3fv");
        _glTexCoord3i = (delegate* unmanaged<int, int, int, void>)QGL.GetGLProcAddress("glTexCoord3i");
        _glTexCoord3iv = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glTexCoord3iv");
        _glTexCoord3s = (delegate* unmanaged<short, short, short, void>)QGL.GetGLProcAddress("glTexCoord3s");
        _glTexCoord3sv = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glTexCoord3sv");
        _glTexCoord4d = (delegate* unmanaged<double, double, double, double, void>)QGL.GetGLProcAddress("glTexCoord4d");
        _glTexCoord4dv = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glTexCoord4dv");
        _glTexCoord4f = (delegate* unmanaged<float, float, float, float, void>)QGL.GetGLProcAddress("glTexCoord4f");
        _glTexCoord4fv = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glTexCoord4fv");
        _glTexCoord4i = (delegate* unmanaged<int, int, int, int, void>)QGL.GetGLProcAddress("glTexCoord4i");
        _glTexCoord4iv = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glTexCoord4iv");
        _glTexCoord4s = (delegate* unmanaged<short, short, short, short, void>)QGL.GetGLProcAddress("glTexCoord4s");
        _glTexCoord4sv = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glTexCoord4sv");
        _glVertex2d = (delegate* unmanaged<double, double, void>)QGL.GetGLProcAddress("glVertex2d");
        _glVertex2dv = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glVertex2dv");
        _glVertex2f = (delegate* unmanaged<float, float, void>)QGL.GetGLProcAddress("glVertex2f");
        _glVertex2fv = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glVertex2fv");
        _glVertex2i = (delegate* unmanaged<int, int, void>)QGL.GetGLProcAddress("glVertex2i");
        _glVertex2iv = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glVertex2iv");
        _glVertex2s = (delegate* unmanaged<short, short, void>)QGL.GetGLProcAddress("glVertex2s");
        _glVertex2sv = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glVertex2sv");
        _glVertex3d = (delegate* unmanaged<double, double, double, void>)QGL.GetGLProcAddress("glVertex3d");
        _glVertex3dv = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glVertex3dv");
        _glVertex3f = (delegate* unmanaged<float, float, float, void>)QGL.GetGLProcAddress("glVertex3f");
        _glVertex3fv = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glVertex3fv");
        _glVertex3i = (delegate* unmanaged<int, int, int, void>)QGL.GetGLProcAddress("glVertex3i");
        _glVertex3iv = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glVertex3iv");
        _glVertex3s = (delegate* unmanaged<short, short, short, void>)QGL.GetGLProcAddress("glVertex3s");
        _glVertex3sv = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glVertex3sv");
        _glVertex4d = (delegate* unmanaged<double, double, double, double, void>)QGL.GetGLProcAddress("glVertex4d");
        _glVertex4dv = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glVertex4dv");
        _glVertex4f = (delegate* unmanaged<float, float, float, float, void>)QGL.GetGLProcAddress("glVertex4f");
        _glVertex4fv = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glVertex4fv");
        _glVertex4i = (delegate* unmanaged<int, int, int, int, void>)QGL.GetGLProcAddress("glVertex4i");
        _glVertex4iv = (delegate* unmanaged<int*, void>)QGL.GetGLProcAddress("glVertex4iv");
        _glVertex4s = (delegate* unmanaged<short, short, short, short, void>)QGL.GetGLProcAddress("glVertex4s");
        _glVertex4sv = (delegate* unmanaged<short*, void>)QGL.GetGLProcAddress("glVertex4sv");
        _glClipPlane = (delegate* unmanaged<uint, double*, void>)QGL.GetGLProcAddress("glClipPlane");
        _glColorMaterial = (delegate* unmanaged<uint, uint, void>)QGL.GetGLProcAddress("glColorMaterial");
        _glFogf = (delegate* unmanaged<uint, float, void>)QGL.GetGLProcAddress("glFogf");
        _glFogfv = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glFogfv");
        _glFogi = (delegate* unmanaged<uint, int, void>)QGL.GetGLProcAddress("glFogi");
        _glFogiv = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glFogiv");
        _glLightf = (delegate* unmanaged<uint, uint, float, void>)QGL.GetGLProcAddress("glLightf");
        _glLightfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glLightfv");
        _glLighti = (delegate* unmanaged<uint, uint, int, void>)QGL.GetGLProcAddress("glLighti");
        _glLightiv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glLightiv");
        _glLightModelf = (delegate* unmanaged<uint, float, void>)QGL.GetGLProcAddress("glLightModelf");
        _glLightModelfv = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glLightModelfv");
        _glLightModeli = (delegate* unmanaged<uint, int, void>)QGL.GetGLProcAddress("glLightModeli");
        _glLightModeliv = (delegate* unmanaged<uint, int*, void>)QGL.GetGLProcAddress("glLightModeliv");
        _glLineStipple = (delegate* unmanaged<int, ushort, void>)QGL.GetGLProcAddress("glLineStipple");
        _glMaterialf = (delegate* unmanaged<uint, uint, float, void>)QGL.GetGLProcAddress("glMaterialf");
        _glMaterialfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glMaterialfv");
        _glMateriali = (delegate* unmanaged<uint, uint, int, void>)QGL.GetGLProcAddress("glMateriali");
        _glMaterialiv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glMaterialiv");
        _glPolygonStipple = (delegate* unmanaged<byte*, void>)QGL.GetGLProcAddress("glPolygonStipple");
        _glShadeModel = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glShadeModel");
        _glTexEnvf = (delegate* unmanaged<uint, uint, float, void>)QGL.GetGLProcAddress("glTexEnvf");
        _glTexEnvfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glTexEnvfv");
        _glTexEnvi = (delegate* unmanaged<uint, uint, int, void>)QGL.GetGLProcAddress("glTexEnvi");
        _glTexEnviv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glTexEnviv");
        _glTexGend = (delegate* unmanaged<uint, uint, double, void>)QGL.GetGLProcAddress("glTexGend");
        _glTexGendv = (delegate* unmanaged<uint, uint, double*, void>)QGL.GetGLProcAddress("glTexGendv");
        _glTexGenf = (delegate* unmanaged<uint, uint, float, void>)QGL.GetGLProcAddress("glTexGenf");
        _glTexGenfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glTexGenfv");
        _glTexGeni = (delegate* unmanaged<uint, uint, int, void>)QGL.GetGLProcAddress("glTexGeni");
        _glTexGeniv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glTexGeniv");
        _glFeedbackBuffer = (delegate* unmanaged<int, uint, float*, void>)QGL.GetGLProcAddress("glFeedbackBuffer");
        _glSelectBuffer = (delegate* unmanaged<int, uint*, void>)QGL.GetGLProcAddress("glSelectBuffer");
        _glRenderMode = (delegate* unmanaged<uint, int>)QGL.GetGLProcAddress("glRenderMode");
        _glInitNames = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glInitNames");
        _glLoadName = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glLoadName");
        _glPassThrough = (delegate* unmanaged<float, void>)QGL.GetGLProcAddress("glPassThrough");
        _glPopName = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glPopName");
        _glPushName = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glPushName");
        _glClearAccum = (delegate* unmanaged<float, float, float, float, void>)QGL.GetGLProcAddress("glClearAccum");
        _glClearIndex = (delegate* unmanaged<float, void>)QGL.GetGLProcAddress("glClearIndex");
        _glIndexMask = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glIndexMask");
        _glAccum = (delegate* unmanaged<uint, float, void>)QGL.GetGLProcAddress("glAccum");
        _glPopAttrib = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glPopAttrib");
        _glPushAttrib = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glPushAttrib");
        _glMap1d = (delegate* unmanaged<uint, double, double, int, int, double*, void>)QGL.GetGLProcAddress("glMap1d");
        _glMap1f = (delegate* unmanaged<uint, float, float, int, int, float*, void>)QGL.GetGLProcAddress("glMap1f");
        _glMap2d = (delegate* unmanaged<uint, double, double, int, int, double, double, int, int, double*, void>)QGL.GetGLProcAddress("glMap2d");
        _glMap2f = (delegate* unmanaged<uint, float, float, int, int, float, float, int, int, float*, void>)QGL.GetGLProcAddress("glMap2f");
        _glMapGrid1d = (delegate* unmanaged<int, double, double, void>)QGL.GetGLProcAddress("glMapGrid1d");
        _glMapGrid1f = (delegate* unmanaged<int, float, float, void>)QGL.GetGLProcAddress("glMapGrid1f");
        _glMapGrid2d = (delegate* unmanaged<int, double, double, int, double, double, void>)QGL.GetGLProcAddress("glMapGrid2d");
        _glMapGrid2f = (delegate* unmanaged<int, float, float, int, float, float, void>)QGL.GetGLProcAddress("glMapGrid2f");
        _glEvalCoord1d = (delegate* unmanaged<double, void>)QGL.GetGLProcAddress("glEvalCoord1d");
        _glEvalCoord1dv = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glEvalCoord1dv");
        _glEvalCoord1f = (delegate* unmanaged<float, void>)QGL.GetGLProcAddress("glEvalCoord1f");
        _glEvalCoord1fv = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glEvalCoord1fv");
        _glEvalCoord2d = (delegate* unmanaged<double, double, void>)QGL.GetGLProcAddress("glEvalCoord2d");
        _glEvalCoord2dv = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glEvalCoord2dv");
        _glEvalCoord2f = (delegate* unmanaged<float, float, void>)QGL.GetGLProcAddress("glEvalCoord2f");
        _glEvalCoord2fv = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glEvalCoord2fv");
        _glEvalMesh1 = (delegate* unmanaged<uint, int, int, void>)QGL.GetGLProcAddress("glEvalMesh1");
        _glEvalPoint1 = (delegate* unmanaged<int, void>)QGL.GetGLProcAddress("glEvalPoint1");
        _glEvalMesh2 = (delegate* unmanaged<uint, int, int, int, int, void>)QGL.GetGLProcAddress("glEvalMesh2");
        _glEvalPoint2 = (delegate* unmanaged<int, int, void>)QGL.GetGLProcAddress("glEvalPoint2");
        _glAlphaFunc = (delegate* unmanaged<uint, float, void>)QGL.GetGLProcAddress("glAlphaFunc");
        _glPixelZoom = (delegate* unmanaged<float, float, void>)QGL.GetGLProcAddress("glPixelZoom");
        _glPixelTransferf = (delegate* unmanaged<uint, float, void>)QGL.GetGLProcAddress("glPixelTransferf");
        _glPixelTransferi = (delegate* unmanaged<uint, int, void>)QGL.GetGLProcAddress("glPixelTransferi");
        _glPixelMapfv = (delegate* unmanaged<uint, int, float*, void>)QGL.GetGLProcAddress("glPixelMapfv");
        _glPixelMapuiv = (delegate* unmanaged<uint, int, uint*, void>)QGL.GetGLProcAddress("glPixelMapuiv");
        _glPixelMapusv = (delegate* unmanaged<uint, int, ushort*, void>)QGL.GetGLProcAddress("glPixelMapusv");
        _glCopyPixels = (delegate* unmanaged<int, int, int, int, uint, void>)QGL.GetGLProcAddress("glCopyPixels");
        _glDrawPixels = (delegate* unmanaged<int, int, uint, uint, void*, void>)QGL.GetGLProcAddress("glDrawPixels");
        _glGetClipPlane = (delegate* unmanaged<uint, double*, void>)QGL.GetGLProcAddress("glGetClipPlane");
        _glGetLightfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetLightfv");
        _glGetLightiv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetLightiv");
        _glGetMapdv = (delegate* unmanaged<uint, uint, double*, void>)QGL.GetGLProcAddress("glGetMapdv");
        _glGetMapfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetMapfv");
        _glGetMapiv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetMapiv");
        _glGetMaterialfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetMaterialfv");
        _glGetMaterialiv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetMaterialiv");
        _glGetPixelMapfv = (delegate* unmanaged<uint, float*, void>)QGL.GetGLProcAddress("glGetPixelMapfv");
        _glGetPixelMapuiv = (delegate* unmanaged<uint, uint*, void>)QGL.GetGLProcAddress("glGetPixelMapuiv");
        _glGetPixelMapusv = (delegate* unmanaged<uint, ushort*, void>)QGL.GetGLProcAddress("glGetPixelMapusv");
        _glGetPolygonStipple = (delegate* unmanaged<byte*, void>)QGL.GetGLProcAddress("glGetPolygonStipple");
        _glGetTexEnvfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetTexEnvfv");
        _glGetTexEnviv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetTexEnviv");
        _glGetTexGendv = (delegate* unmanaged<uint, uint, double*, void>)QGL.GetGLProcAddress("glGetTexGendv");
        _glGetTexGenfv = (delegate* unmanaged<uint, uint, float*, void>)QGL.GetGLProcAddress("glGetTexGenfv");
        _glGetTexGeniv = (delegate* unmanaged<uint, uint, int*, void>)QGL.GetGLProcAddress("glGetTexGeniv");
        _glIsList = (delegate* unmanaged<uint, bool>)QGL.GetGLProcAddress("glIsList");
        _glFrustum = (delegate* unmanaged<double, double, double, double, double, double, void>)QGL.GetGLProcAddress("glFrustum");
        _glLoadIdentity = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glLoadIdentity");
        _glLoadMatrixf = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glLoadMatrixf");
        _glLoadMatrixd = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glLoadMatrixd");
        _glMatrixMode = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glMatrixMode");
        _glMultMatrixf = (delegate* unmanaged<float*, void>)QGL.GetGLProcAddress("glMultMatrixf");
        _glMultMatrixd = (delegate* unmanaged<double*, void>)QGL.GetGLProcAddress("glMultMatrixd");
        _glOrtho = (delegate* unmanaged<double, double, double, double, double, double, void>)QGL.GetGLProcAddress("glOrtho");
        _glPopMatrix = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glPopMatrix");
        _glPushMatrix = (delegate* unmanaged<void>)QGL.GetGLProcAddress("glPushMatrix");
        _glRotated = (delegate* unmanaged<double, double, double, double, void>)QGL.GetGLProcAddress("glRotated");
        _glRotatef = (delegate* unmanaged<float, float, float, float, void>)QGL.GetGLProcAddress("glRotatef");
        _glScaled = (delegate* unmanaged<double, double, double, void>)QGL.GetGLProcAddress("glScaled");
        _glScalef = (delegate* unmanaged<float, float, float, void>)QGL.GetGLProcAddress("glScalef");
        _glTranslated = (delegate* unmanaged<double, double, double, void>)QGL.GetGLProcAddress("glTranslated");
        _glTranslatef = (delegate* unmanaged<float, float, float, void>)QGL.GetGLProcAddress("glTranslatef");
    }
