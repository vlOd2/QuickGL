...
public static unsafe class GL32
{
    ...
    internal static void Load()
    {
        ...
        _glMultiDrawElementsBaseVertex = (delegate* unmanaged<uint, int*, uint, void**, int, int*, void>)QGL.GetGLProcAddress("glMultiDrawElementsBaseVertex");
        _glProvokingVertex = (delegate* unmanaged<uint, void>)QGL.GetGLProcAddress("glProvokingVertex");
        ...
        _glTexImage2DMultisample = (delegate* unmanaged<uint, int, uint, int, int, bool, void>)QGL.GetGLProcAddress("glTexImage2DMultisample");
        _glTexImage3DMultisample = (delegate* unmanaged<uint, int, uint, int, int, int, bool, void>)QGL.GetGLProcAddress("glTexImage3DMultisample");
